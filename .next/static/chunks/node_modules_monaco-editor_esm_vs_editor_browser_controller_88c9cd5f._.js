...
class MouseTarget {
    static _deduceRage(position) {
        let range = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
        if (!range && position) {
...
class HitTestContext {
    ...
    isRtl(lineNumber) {
        return this.viewModel.getTextDirection(lineNumber) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$model$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextDirection"].RTL;
    }
...
class HitTestRequest extends BareHitTestRequest {
    ...
    _getMouseColumn() {
        let position = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
...
class MouseTargetFactory {
        ...
        if (ElementPath.isStrictChildOfViewLines(request.targetPath)) {
            ...
            if (ctx.viewLinesGpu) {
                ...
                if (position) {
                    ...
                    return request.fulfillContentText(position, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].fromPositions(position, position), detail);
                }
            }
        }
    ...
    static createMouseTargetFromHitTestPosition(ctx, request, spanNode, pos, injectedText) {
        ...
        const mouseCoordinates = request.pos.toClientCoordinates(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](ctx.viewDomNode));
     ...
     */ static _doHitTestWithCaretRangeFromPoint(ctx, request) {
        ...
        if (!isBelowLastLine) {
            ...
            const r = this._actualDoHitTestWithCaretRangeFromPoint(ctx, adjustedPage.toClientCoordinates(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](ctx.viewDomNode)));
            if (r.type === 1 /* HitTestResultType.Content */ ) {
                return r;
            }
        }
        // Also try to hit test without the adjustment (for the edge cases that we are near the top or bottom)
        return this._actualDoHitTestWithCaretRangeFromPoint(ctx, request.pos.toClientCoordinates(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](ctx.viewDomNode)));
    }
    static _actualDoHitTestWithCaretRangeFromPoint(ctx, coords) {
        const shadowRoot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShadowRoot"](ctx.viewDomNode);
        let range;
        if (shadowRoot) {
        ...
        if (startContainer.nodeType === startContainer.TEXT_NODE) {
            ...
            if (parent3ClassName === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewLine"].CLASS_NAME) {
            ...
            if (parent2ClassName === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewLine"].CLASS_NAME) {
     ...
     */ static _doHitTestWithCaretPositionFromPoint(ctx, coords) {
        ...
        if (hitResult.offsetNode.nodeType === hitResult.offsetNode.ELEMENT_NODE) {
            ...
            const parent2ClassName = parent2 && parent2.nodeType === parent2.ELEMENT_NODE ? parent2.className : null;
            if (parent1ClassName === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewLine"].CLASS_NAME) {
                // it returned the `<span>` of the line and the offset is the `<span>` with the inline decoration
                const tokenSpan = hitResult.offsetNode.childNodes[Math.min(hitResult.offset, hitResult.offsetNode.childNodes.length - 1)];
                if (tokenSpan) {
                    return HitTestResult.createFromDOMInfo(ctx, tokenSpan, 0);
                }
            } else if (parent2ClassName === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewLine"].CLASS_NAME) {
    ...
    static doHitTest(ctx, request) {
        ...
        if (typeof ctx.viewDomNode.ownerDocument.caretRangeFromPoint === 'function') {
            ...
            result = this._doHitTestWithCaretPositionFromPoint(ctx, request.pos.toClientCoordinates(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](ctx.viewDomNode)));
        }
...
function shadowCaretRangeFromPoint(shadowRoot, x, y) {
    ...
    if (el === null || el === void 0 ? void 0 : el.hasChildNodes()) {
        ...
        const elWindow = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](el);
        ...
        const font = "".concat(fontStyle, " ").concat(fontVariant, " ").concat(fontWeight, " ").concat(fontSize, "/").concat(lineHeight, " ").concat(fontFamily);
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/dragScrolling.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class DragScrolling extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    dispose() {
        super.dispose();
        this.stop();
    }
...
class DragScrollingOperation extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    dispose() {
    ...
    constructor(_context, _viewHelper, _mouseTargetFactory, _dispatchMouse, position, mouseEvent){
        ...
        this._animationFrameDisposable = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleAtNextAnimationFrame"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](mouseEvent.browserEvent), ()=>this._execute());
    }
}
...
class TopBottomDragScrollingOperation extends DragScrollingOperation {
    ...
    _execute() {
        ...
        this._animationFrameDisposable = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleAtNextAnimationFrame"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](mouseTarget.element), ()=>this._execute());
    }
}
...
class LeftRightDragScrollingOperation extends DragScrollingOperation {
    ...
    _execute() {
        ...
        if (this._position.outsidePosition === 'left') {
            mouseTarget = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$mouseTarget$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MouseTarget"].createOutsideEditor(mouseTarget.mouseColumn, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$position$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Position"](edgeLineNumber, mouseTarget.mouseColumn), 'left', this._position.outsideDistance);
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$dragScrolling$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/dragScrolling.js [app-client] (ecmascript)");
;
;
;
;
...
class MouseHandler extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewEventHandler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewEventHandler"] {
    _setupMouseWheelZoomListener() {
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.viewDomNode, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].MOUSE_WHEEL, onMouseWheel, {
            capture: true,
            passive: false
        }));
    ...
    getTargetAtClientPoint(clientX, clientY) {
        ...
        const pos = clientPos.toPageCoordinates(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](this.viewHelper.viewDomNode));
    ...
    _createMouseTarget(e, testEventTarget) {
        ...
        if (!this.viewHelper.viewDomNode.contains(target)) {
            const shadowRoot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShadowRoot"](this.viewHelper.viewDomNode);
            if (shadowRoot) {
    ...
    constructor(context, viewController, viewHelper){
        ...
        this._register(mouseEvents.onMouseMove(this.viewHelper.viewDomNode, (e)=>{
            ...
            if (!this._mouseLeaveMonitor) {
                this._mouseLeaveMonitor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.viewDomNode.ownerDocument, 'mousemove', (e)=>{
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.viewDomNode, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].POINTER_UP, (e)=>{
...
class MouseDownOperation extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
        ...
        if (!options.get(103 /* EditorOption.readOnly */ ) && options.get(42 /* EditorOption.dragAndDrop */ ) && !options.get(28 /* EditorOption.columnSelection */ ) && !this._mouseState.altKey // we don't support multiple mouse
         ...
         && position.type === 6 /* MouseTargetType.CONTENT_TEXT */  && position.position && this._currentSelection.containsPosition(position.position) // single click on a selection
            ...
            this._mouseMoveMonitor.startMonitoring(this._viewHelper.viewLinesDomNode, pointerId, e.buttons, (e)=>this._onMouseDownThenMove(e), (browserEvent)=>{
                ...
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isKeyboardEvent"](browserEvent)) {
                    // cancel
    ...
    constructor(_context, _viewController, _viewHelper, _mouseTargetFactory, createMouseTarget, getMouseColumn){
        ...
        this._topBottomDragScrolling = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$dragScrolling$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TopBottomDragScrolling"](this._context, this._viewHelper, this._mouseTargetFactory, (position, inSelectionMode, revealType)=>this._dispatchMouse(position, inSelectionMode, revealType)));
        this._leftRightDragScrolling = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$dragScrolling$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LeftRightDragScrolling"](this._context, this._viewHelper, this._mouseTargetFactory, (position, inSelectionMode, revealType)=>this._dispatchMouse(position, inSelectionMode, revealType)));
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/clipboardUtils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getDataToCopy(viewModel, modelSelections, emptySelectionClipboard, copyWithSyntaxHighlighting) {
    const rawTextToCopy = viewModel.getPlainTextToCopy(modelSelections, emptySelectionClipboard, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWindows"]);
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContextState.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TextAreaState {
    ...
    deduceEditorPosition(offset) {
        ...
        if (offset <= this.selectionStart) {
            var _this_selection1;
            const str = this.value.substring(offset, this.selectionStart);
            var _this_selection_getStartPosition;
            return this._finishDeduceEditorPosition((_this_selection_getStartPosition = (_this_selection1 = this.selection) === null || _this_selection1 === void 0 ? void 0 : _this_selection1.getStartPosition()) !== null && _this_selection_getStartPosition !== void 0 ? _this_selection_getStartPosition : null, str, -1);
        }
        if (offset >= this.selectionEnd) {
            var _this_selection2;
            const str = this.value.substring(this.selectionEnd, offset);
            var _this_selection_getEndPosition;
            return this._finishDeduceEditorPosition((_this_selection_getEndPosition = (_this_selection2 = this.selection) === null || _this_selection2 === void 0 ? void 0 : _this_selection2.getEndPosition()) !== null && _this_selection_getEndPosition !== void 0 ? _this_selection_getEndPosition : null, str, 1);
        }
        const str1 = this.value.substring(this.selectionStart, offset);
        if (str1.indexOf(String.fromCharCode(8230)) === -1) {
            var _this_selection3;
            var _this_selection_getStartPosition1;
            return this._finishDeduceEditorPosition((_this_selection_getStartPosition1 = (_this_selection3 = this.selection) === null || _this_selection3 === void 0 ? void 0 : _this_selection3.getStartPosition()) !== null && _this_selection_getStartPosition1 !== void 0 ? _this_selection_getStartPosition1 : null, str1, 1);
        }
        const str2 = this.value.substring(offset, this.selectionEnd);
        var _this_selection_getEndPosition1;
        return this._finishDeduceEditorPosition((_this_selection_getEndPosition1 = (_this_selection = this.selection) === null || _this_selection === void 0 ? void 0 : _this_selection.getEndPosition()) !== null && _this_selection_getEndPosition1 !== void 0 ? _this_selection_getEndPosition1 : null, str2, -1);
    }
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContextInput.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContextState.js [app-client] (ecmascript)");
 ...
 */ let TextAreaInput = class TextAreaInput extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    _installSelectionChangeListener() {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this._textArea.ownerDocument, 'selectionchange', (e)=>{
    ...
    _ensureClipboardGetsEditorSelection(e) {
        ...
        let id = undefined;
        if (this._logService.getLevel() === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$log$2f$common$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].Trace) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryClipboardMetadataManager"].INSTANCE.set(this._browser.isFirefox ? dataToCopy.text.replace(/\r\n/g, '\n') : dataToCopy.text, storedMetadata);
        e.preventDefault();
        if (e.clipboardData) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClipboardEventUtils"].setTextData(e.clipboardData, dataToCopy.text, dataToCopy.html, storedMetadata);
        }
    ...
    constructor(_host, _textArea, _OS, _browser, _accessibilityService, _logService){
        ...
        this._textAreaState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].EMPTY;
        this._selectionChangeListener = null;
        ...
        this._register(this._textArea.onCompositionStart((e)=>{
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_debugComposition"]) {
        ...
        this._register(this._textArea.onCompositionUpdate((e)=>{
            ...
            if (this._browser.isAndroid) {
                ...
                const newState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].readFromTextArea(this._textArea, this._textAreaState);
                const typeInput = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].deduceAndroidCompositionInput(this._textAreaState, newState);
            ...
            this._textAreaState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].readFromTextArea(this._textArea, this._textAreaState);
            this._onType.fire(typeInput);
            this._onCompositionUpdate.fire(e);
        }));
        ...
        this._register(this._textArea.onInput((e)=>{
            ...
            const newState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].readFromTextArea(this._textArea, this._textAreaState);
            const typeInput = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].deduceInput(this._textAreaState, newState, /*couldBeEmojiInput*/ this._OS === 2 /* OperatingSystem.Macintosh */ );
            if (typeInput.replacePrevCharCnt === 0 && typeInput.text.length === 1) {
                // one character was typed
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHighSurrogate"](typeInput.text.charCodeAt(0)) || typeInput.text.charCodeAt(0) === 0x7f /* Delete */ ) {
            ...
            if (typeInput.text !== '' || typeInput.replacePrevCharCnt !== 0 || typeInput.replaceNextCharCnt !== 0 || typeInput.positionDelta !== 0) {
                ...
                if (e.inputType === 'insertFromPaste') {
                    this._onPaste.fire({
                        text: typeInput.text,
                        metadata: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryClipboardMetadataManager"].INSTANCE.get(typeInput.text)
                    });
                } else {
                    this._onType.fire(typeInput);
                }
        ...
        this._register(this._textArea.onPaste((e)=>{
            ...
            let [text, metadata] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClipboardEventUtils"].getTextData(e.clipboardData);
            this._logService.trace("TextAreaInput#onPaste with id : ", metadata === null || metadata === void 0 ? void 0 : metadata.id, ' with text.length: ', text.length);
            if (!text) {
                return;
            }
            // try the in-memory store
            metadata = metadata || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryClipboardMetadataManager"].INSTANCE.get(text);
...
class TextAreaWrapper extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    hasFocus() {
        const shadowRoot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShadowRoot"](this._actual);
        if (shadowRoot) {
            return shadowRoot.activeElement === this._actual;
        } else if (this._actual.isConnected) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveElement"]() === this._actual;
        } else {
            return false;
        }
    }
    ...
    setSelectionRange(reason, selectionStart, selectionEnd) {
        ...
        const shadowRoot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShadowRoot"](textArea);
        if (shadowRoot) {
            activeElement = shadowRoot.activeElement;
        } else {
            activeElement = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveElement"]();
        }
        const activeWindow = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](activeElement);
        ...
        try {
            const scrollState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveParentsScrollTop"](textArea);
            this.setIgnoreSelectionChangeTime('setSelectionRange');
            textArea.focus();
            textArea.setSelectionRange(selectionStart, selectionEnd);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restoreParentsScrollTop"](textArea, scrollState);
        } catch (e) {
    ...
    constructor(_actual){
        ...
        this.onKeyPress = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DomEmitter"](this._actual, 'keypress')).event;
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this._actual, TextAreaSyntethicEvents.Tap, ()=>this._onSyntheticTap.fire()));
    }
...
class PointerEventHandler extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$mouseHandler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MouseHandler"] {
    ...
    constructor(context, viewController, viewHelper){
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.linesContentDomNode, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$touch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].Tap, (e)=>this.onTap(e)));
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.linesContentDomNode, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$touch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].Change, (e)=>this.onChange(e)));
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.linesContentDomNode, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$touch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].Contextmenu, (e)=>this._onContextMenu(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$editorDom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorMouseEvent"](e, false, this.viewHelper.viewDomNode), false)));
        this._lastPointerType = 'mouse';
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](this.viewHelper.linesContentDomNode, 'pointerdown', (e)=>{
...
class TouchHandler extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$mouseHandler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MouseHandler"] {
    onTap(event) {
        ...
        if (target.position) {
            ...
            event.initEvent(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextInput$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaSyntethicEvents"].Tap, false, true);
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/editContext.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$view$2f$viewPart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/view/viewPart.js [app-client] (ecmascript)");
;
class AbstractEditContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$view$2f$viewPart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewPart"] {
} //# sourceMappingURL=editContext.js.map
}),
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/screenReaderUtils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ariaLabelForScreenReaderContent(options, keybindingService) {
    ...
    if (accessibilitySupport === 1 /* AccessibilitySupport.Disabled */ ) {
        var _keybindingService_lookupKeybinding, _keybindingService_lookupKeybinding1, _keybindingService_lookupKeybinding2;
        const toggleKeybindingLabel = (_keybindingService_lookupKeybinding = keybindingService.lookupKeybinding('editor.action.toggleScreenReaderAccessibilityMode')) === null || _keybindingService_lookupKeybinding === void 0 ? void 0 : _keybindingService_lookupKeybinding.getAriaLabel();
        const runCommandKeybindingLabel = (_keybindingService_lookupKeybinding1 = keybindingService.lookupKeybinding('workbench.action.showCommands')) === null || _keybindingService_lookupKeybinding1 === void 0 ? void 0 : _keybindingService_lookupKeybinding1.getAriaLabel();
        const keybindingEditorKeybindingLabel = (_keybindingService_lookupKeybinding2 = keybindingService.lookupKeybinding('workbench.action.openGlobalKeybindings')) === null || _keybindingService_lookupKeybinding2 === void 0 ? void 0 : _keybindingService_lookupKeybinding2.getAriaLabel();
        const editorNotAccessibleMessage = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](56, "The editor is not accessible at this time.");
        if (toggleKeybindingLabel) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](57, "{0} To enable screen reader optimized mode, use {1}", editorNotAccessibleMessage, toggleKeybindingLabel);
        } else if (runCommandKeybindingLabel) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](58, "{0} To enable screen reader optimized mode, open the quick pick with {1} and run the command Toggle Screen Reader Accessibility Mode, which is currently not triggerable via keyboard.", editorNotAccessibleMessage, runCommandKeybindingLabel);
        } else if (keybindingEditorKeybindingLabel) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](59, "{0} Please assign a keybinding for the command Toggle Screen Reader Accessibility Mode by accessing the keybindings editor with {1} and run it.", editorNotAccessibleMessage, keybindingEditorKeybindingLabel);
        } else {
            // SOS
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContext.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$editContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/editContext.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextInput$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContextInput.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$screenReaderUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/screenReaderUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/clipboardUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/textArea/textAreaEditContextState.js [app-client] (ecmascript)");
...
let TextAreaEditContext = class TextAreaEditContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$editContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AbstractEditContext"] {
    get domNode() {
    ...
    _getCharacterBeforePosition(position) {
        if (position.column > 1) {
            ...
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHighSurrogate"](charBefore.charCodeAt(0))) {
                return charBefore;
            }
        }
        return '';
    ...
    _ensureReadOnlyAttribute() {
        ...
        const useReadOnly = !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].enabled || options.get(41 /* EditorOption.domReadOnly */ ) && options.get(103 /* EditorOption.readOnly */ );
        if (useReadOnly) {
    ...
    prepareRender(ctx) {
        ...
        (_this__visibleTextArea = this._visibleTextArea) === null || _this__visibleTextArea === void 0 ? void 0 : _this__visibleTextArea.prepareRender(ctx);
    }
    render(ctx) {
    ...
    _render() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMacintosh"] || this._accessibilitySupport === 2 /* AccessibilitySupport.Enabled */ ) {
            ...
            var _this__textAreaInput_textAreaState_newlineCountBeforeSelection;
            const lineCount = (_this__textAreaInput_textAreaState_newlineCountBeforeSelection = this._textAreaInput.textAreaState.newlineCountBeforeSelection) !== null && _this__textAreaInput_textAreaState_newlineCountBeforeSelection !== void 0 ? _this__textAreaInput_textAreaState_newlineCountBeforeSelection : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$screenReaderUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newlinecount"])(this.textArea.domNode.value.substring(0, this.textArea.domNode.selectionStart));
            this.textArea.domNode.scrollTop = lineCount * lineHeight;
            return;
        }
        this._doRender({
    ...
    _doRender(renderData) {
        ...
        var _renderData_fontSize;
        ta.setFontSize((_renderData_fontSize = renderData.fontSize) !== null && _renderData_fontSize !== void 0 ? _renderData_fontSize : this._fontInfo.fontSize);
    ...
    constructor(context, overflowGuardContainer, viewController, visibleRangeProvider, _keybindingService, _instantiationService){
        ...
        this.textArea.setClassName("inputarea ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$mouseCursor$2f$mouseCursor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOUSE_CURSOR_TEXT_CSS_CLASS_NAME"]));
        this.textArea.setAttribute('wrap', this._textAreaWrapping && !this._visibleTextArea ? 'on' : 'off');
        const { tabSize } = this._context.viewModel.model.getOptions();
        this.textArea.domNode.style.tabSize = "".concat(tabSize * this._fontInfo.spaceWidth, "px");
        ...
        this.textArea.setAttribute('aria-roledescription', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](60, "editor"));
        ...
        const simplePagedScreenReaderStrategy = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$screenReaderUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimplePagedScreenReaderStrategy"]();
        const textAreaInputHost = {
            getDataToCopy: ()=>{
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDataToCopy"])(this._context.viewModel, this._modelSelections, this._emptySelectionClipboard, this._copyWithSyntaxHighlighting);
            },
            getScreenReaderContent: ()=>{
                if (this._accessibilitySupport === 1 /* AccessibilitySupport.Disabled */ ) {
                    ...
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMacintosh"] && selection.isEmpty()) {
                        ...
                        if (textBefore.length > 0) {
                            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"](textBefore, textBefore.length, textBefore.length, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].fromPositions(position), 0);
                        }
                    }
                    ...
                    const LIMIT_CHARS = 500;
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMacintosh"] && !selection.isEmpty() && this._context.viewModel.getValueLengthInRange(selection, 0 /* EndOfLinePreference.TextDefined */ ) < LIMIT_CHARS) {
                        const text = this._context.viewModel.getValueInRange(selection, 0 /* EndOfLinePreference.TextDefined */ );
                        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"](text, 0, text.length, selection, 0);
                    }
                    ...
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSafari"] && !selection.isEmpty()) {
                        ...
                        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"](placeholderText, 0, placeholderText.length, null, undefined);
                    }
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].EMPTY;
                }
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAndroid"]) {
                    ...
                    if (selection.isEmpty()) {
                        ...
                        if (wordAtPosition.length > 0) {
                            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"](wordAtPosition, positionOffsetInWord, positionOffsetInWord, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].fromPositions(position), 0);
                        }
                    }
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$textArea$2f$textAreaEditContextState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextAreaState"].EMPTY;
                }
        ...
        this._register(this._textAreaInput.onCompositionStart((e)=>{
            ...
            this._render();
            // Show the textarea
            this.textArea.setClassName("inputarea ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$mouseCursor$2f$mouseCursor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOUSE_CURSOR_TEXT_CSS_CLASS_NAME"], " ime-input"));
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/nativeEditContextUtils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
let FocusTracker = class FocusTracker extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    pause() {
        this._isPaused = true;
    }
    resume() {
    ...
    refreshFocusState() {
        const shadowRoot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShadowRoot"])(this._domNode);
        const activeElement = shadowRoot ? shadowRoot.activeElement : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveElement"])();
    ...
    constructor(_logService, _domNode, _onFocusChange){
        ...
        this._isPaused = false;
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._domNode, 'focus', ()=>{
        ...
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._domNode, 'blur', ()=>{
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderContentRich.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ttPolicy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$trustedTypes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTrustedTypesPolicy"])('richScreenReaderContent', {
    createHTML: (value)=>value
});
const LINE_NUMBER_ATTRIBUTE = 'data-line-number';
let RichScreenReaderContent = class RichScreenReaderContent extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    updateScreenReaderContent(primarySelection) {
        const focusedElement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveWindow"])().document.activeElement;
    ...
    _setSelectionChangeListener() {
        ...
        // so throttle multiple `selectionchange` events that burst in a short period of time.
        let previousSelectionChangeEventTime = 0;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._domNode.domNode.ownerDocument, 'selectionchange', ()=>{
            const activeElement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveWindow"])().document.activeElement;
            const isFocused = activeElement === this._domNode.domNode;
            if (!isFocused) {
                return;
            }
            const isScreenReaderOptimized = this._accessibilityService.isScreenReaderOptimized();
            if (!isScreenReaderOptimized || !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].enabled) {
                return;
            }
            const now = Date.now();
            const delta1 = now - previousSelectionChangeEventTime;
    ...
    _renderLine(viewLineNumber) {
        ...
        const lineDecorations = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$lineDecorations$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineDecoration"].filter(positionLineData.inlineDecorations, viewLineNumber, positionLineData.minColumn, positionLineData.maxColumn);
        const useMonospaceOptimizations = fontInfo.isMonospace && !disableMonospaceOptimizations;
        const useFontLigatures = fontLigatures !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$config$2f$editorOptions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorFontLigatures"].OFF;
        ...
        const renderLineInput = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$viewLineRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderLineInput"](useMonospaceOptimizations, fontInfo.canUseHalfwidthRightwardsArrow, positionLineData.content, positionLineData.continuesWithWrappedLine, positionLineData.isBasicASCII, positionLineData.containsRTL, positionLineData.minColumn - 1, positionLineData.tokens, lineDecorations, positionLineData.tabSize, positionLineData.startVisibleColumn, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, stopRenderingLineAfter, renderWhitespace, renderControlCharacters, useFontLigatures, null, null, 0, true);
        const htmlBuilder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$stringBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StringBuilder"](10000);
        const renderOutput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$viewLineRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderViewLine"])(renderLineInput, htmlBuilder);
    ...
    _setSelectionOnScreenReaderContent(context, renderedLines, viewSelection) {
        const activeDocument = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveWindow"])().document;
        ...
        const startRange = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"](startLineNumber, 1, startLineNumber, viewSelection.selectionStartColumn);
        ...
        const endRange = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"](endLineNumber, 1, endLineNumber, viewSelection.positionColumn);
    ...
    _getEditorSelectionFromDomRange() {
        var _startSpanElement_parentElement, _endSpanElement_parentElement, _this__renderedLines_get, _this__renderedLines_get1;
        if (!this._renderedLines) {
            return;
        }
        const selection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveWindow"])().document.getSelection();
        if (!selection) {
            return;
        }
        ...
        if (!startSpanElement || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHTMLElement"])(startSpanElement) || !endSpanElement || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHTMLElement"])(endSpanElement)) {
            return;
        }
        const startLineDomNode = (_startSpanElement_parentElement = startSpanElement.parentElement) === null || _startSpanElement_parentElement === void 0 ? void 0 : _startSpanElement_parentElement.parentElement;
        const endLineDomNode = (_endSpanElement_parentElement = endSpanElement.parentElement) === null || _endSpanElement_parentElement === void 0 ? void 0 : _endSpanElement_parentElement.parentElement;
        ...
        const startMapping = (_this__renderedLines_get = this._renderedLines.get(startLineNumber)) === null || _this__renderedLines_get === void 0 ? void 0 : _this__renderedLines_get.characterMapping;
        const endMapping = (_this__renderedLines_get1 = this._renderedLines.get(endLineNumber)) === null || _this__renderedLines_get1 === void 0 ? void 0 : _this__renderedLines_get1.characterMapping;
        if (!startMapping || !endMapping) {
            return;
        }
        const startColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnOfNodeOffset"])(startMapping, startSpanElement, range.startOffset);
        const endColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$viewParts$2f$viewLines$2f$viewLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnOfNodeOffset"])(endMapping, endSpanElement, range.endOffset);
        if (selection.direction === 'forward') {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](startLineNumber, startColumn, endLineNumber, endColumn);
        } else {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](endLineNumber, endColumn, startLineNumber, startColumn);
        }
    }
    constructor(_domNode, _context, _viewController, _accessibilityService){
        ...
        this._viewController = _viewController;
        this._accessibilityService = _accessibilityService;
        this._selectionChangeListener = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MutableDisposable"]());
        this._accessibilityPageSize = 1;
        this._ignoreSelectionChangeTime = 0;
        this._state = new RichScreenReaderState([]);
        this._strategy = new RichPagedScreenReaderStrategy();
        this._renderedLines = new Map();
        this._renderedSelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderContentSimple.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
let SimpleScreenReaderContent = class SimpleScreenReaderContent extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    updateScreenReaderContent(primarySelection) {
    ...
    _setSelectionChangeListener() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._domNode.domNode.ownerDocument, 'selectionchange', ()=>{
            const isScreenReaderOptimized = this._accessibilityService.isScreenReaderOptimized();
            if (!this._state || !isScreenReaderOptimized || !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].enabled) {
                return;
            }
            const activeElement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveWindow"])().document.activeElement;
            const isFocused = activeElement === this._domNode.domNode;
    ...
    _getEditorSelectionFromDomRange(context, state, direction, range) {
        ...
        if (modelUsesCRLF) {
            ...
            const offsetTransformer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$text$2f$positionToOffsetImpl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PositionOffsetTransformer"](screenReaderContentText);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"].fromPositions(selectionStart, selectionEnd);
    }
    constructor(_domNode, _context, _viewController, _accessibilityService){
        super();
        this._domNode = _domNode;
        ...
        this._accessibilityPageSize = 1;
        this._ignoreSelectionChangeTime = 0;
        this._strategy = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$screenReaderUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimplePagedScreenReaderStrategy"]();
        this.onConfigurationChanged(this._context.configuration.options);
    }
};
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderSupport.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$config$2f$domFontInfo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/config/domFontInfo.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$screenReaderUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/screenReaderUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderContentRich$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderContentRich.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderContentSimple$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderContentSimple.js [app-client] (ecmascript)");
var __decorate = ("TURBOPACK compile-time value", void 0) && ("TURBOPACK compile-time value", void 0).__decorate || function(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for(var i = decorators.length - 1; i >= 0; i--)if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
;
;
let ScreenReaderSupport = class ScreenReaderSupport extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    onWillPaste() {
        var _this__state_value;
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.onWillPaste();
    }
    onWillCut() {
        var _this__state_value;
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.onWillCut();
    }
    handleFocusChange(newFocusValue) {
        var _this__state_value;
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.onFocusChange(newFocusValue);
    ...
    _createScreenReaderContent(renderRichContent) {
        if (renderRichContent) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderContentRich$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RichScreenReaderContent"](this._domNode, this._context, this._viewController, this._accessibilityService);
        } else {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderContentSimple$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimpleScreenReaderContent"](this._domNode, this._context, this._viewController, this._accessibilityService);
        }
    }
    _updateConfigurationSettings() {
        ...
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.onConfigurationChanged(options);
    }
    _updateDomAttributes() {
        ...
        this._domNode.domNode.setAttribute('aria-roledescription', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(55, "editor"));
        ...
        this._domNode.domNode.style.tabSize = "".concat(tabSize * spaceWidth, "px");
    ...
    onCursorStateChanged(e) {
        var _e_selections_;
        this._primarySelection = (_e_selections_ = e.selections[0]) !== null && _e_selections_ !== void 0 ? _e_selections_ : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
    }
    prepareRender(ctx) {
        this.writeScreenReaderContent();
    ...
    render(ctx) {
        ...
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.updateScrollTop(this._primarySelection);
    }
    _renderAtTopLeft() {
    ...
    _doRender(top, left, width, height) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$config$2f$domFontInfo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyFontInfo"])(this._domNode, this._fontInfo);
    ...
    writeScreenReaderContent() {
        var _this__state_value;
        (_this__state_value = this._state.value) === null || _this__state_value === void 0 ? void 0 : _this__state_value.updateScreenReaderContent(this._primarySelection);
    }
    constructor(_domNode, _context, _viewController, _keybindingService, _accessibilityService){
        ...
        this._divWidth = 1;
        this._primarySelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
        this._primaryCursorVisibleRange = null;
        this._state = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MutableDisposable"]());
        this._instantiateScreenReaderContent();
        this._updateConfigurationSettings();
        this._updateDomAttributes();
    }
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/editContextFactory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/nativeEditContextRegistry.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/nativeEditContext.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/clipboardUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$editContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/editContext.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/nativeEditContextUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderSupport$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/screenReaderSupport.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/core/range.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/core/selection.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$position$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/core/position.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$text$2f$positionToOffset$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/core/text/positionToOffset.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$text$2f$positionToOffsetImpl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/core/text/positionToOffsetImpl.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$editContextFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/browser/controller/editContext/native/editContextFactory.js [app-client] (ecmascript)");
...
let NativeEditContext = class NativeEditContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$editContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AbstractEditContext"] {
    // --- Public methods ---
    dispose() {
    ...
    onCursorStateChanged(e) {
        var _e_modelSelections_;
        this._primarySelection = (_e_modelSelections_ = e.modelSelections[0]) !== null && _e_modelSelections_ !== void 0 ? _e_modelSelections_ : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
    ...
    onWillCopy() {
        ...
        this.logService.trace('NativeEditContext#isFocused : ', this.domNode.domNode === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveElement"])());
    }
    writeScreenReaderContent() {
    ...
    setEditContextOnDomNode() {
        const targetWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"])(this.domNode.domNode);
    ...
    // --- Private methods ---
    _onKeyUp(e) {
        this._viewController.emitKeyUp(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$keyboardEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardKeyboardEvent"](e));
    }
    _onKeyDown(e) {
        const standardKeyboardEvent = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$keyboardEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardKeyboardEvent"](e);
    ...
    _updateEditContext() {
        ...
        var _editContextState_text;
        this._editContext.updateText(0, Number.MAX_SAFE_INTEGER, (_editContextState_text = editContextState.text) !== null && _editContextState_text !== void 0 ? _editContextState_text : ' ');
        this._editContext.updateSelection(editContextState.selectionStartOffset, editContextState.selectionEndOffset);
        this._editContextPrimarySelection = editContextState.editContextPrimarySelection;
        this._previousEditContextSelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$ranges$2f$offsetRange$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OffsetRange"](editContextState.selectionStartOffset, editContextState.selectionEndOffset);
    }
    _emitTypeEvent(viewController, e) {
        ...
        this._previousEditContextSelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$ranges$2f$offsetRange$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OffsetRange"](e.selectionStart, e.selectionEnd);
    ...
    _getNewEditContextState() {
        ...
        const rangeOfText = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"](primarySelectionStartLine, 1, primarySelectionEndLine, endColumnOfEndLineNumber);
    ...
    _editContextStartPosition() {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$position$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Position"](this._editContextPrimarySelection.startLineNumber, 1);
    }
    _handleTextFormatUpdate(e) {
        ...
        formats.forEach((f)=>{
            ...
            const decorationRange = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].fromPositions(startPositionOfDecoration, endPositionOfDecoration);
    ...
    _updateCharacterBounds(e) {
        ...
        const offsetTransformer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$text$2f$positionToOffsetImpl$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PositionOffsetTransformer"](this._editContext.text);
        for(let offset = e.rangeStart; offset < e.rangeEnd; offset++){
            ...
            const characterStartPosition = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$position$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Position"](textStartLineOffsetWithinEditor + editContextStartPosition.lineNumber, editContextStartPosition.column);
            const characterEndPosition = characterStartPosition.delta(0, 1);
            const characterModelRange = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$range$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].fromPositions(characterStartPosition, characterEndPosition);
            const characterViewRange = this._context.viewModel.coordinatesConverter.convertModelRangeToViewRange(characterModelRange);
            var _this__visibleRangeProvider_linesVisibleRangesForRange;
            const characterLinesVisibleRanges = (_this__visibleRangeProvider_linesVisibleRangesForRange = this._visibleRangeProvider.linesVisibleRangesForRange(characterViewRange, true)) !== null && _this__visibleRangeProvider_linesVisibleRangesForRange !== void 0 ? _this__visibleRangeProvider_linesVisibleRangesForRange : [];
    ...
    _ensureClipboardGetsEditorSelection(e) {
        ...
        const dataToCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDataToCopy"])(this._context.viewModel, selections, emptySelectionClipboard, copyWithSyntaxHighlighting);
        let id = undefined;
        if (this.logService.getLevel() === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$log$2f$common$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].Trace) {
            id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$uuid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateUuid"])();
        }
        const storedMetadata = {
            version: 1,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryClipboardMetadataManager"].INSTANCE.set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirefox"] ? dataToCopy.text.replace(/\r\n/g, '\n') : dataToCopy.text, storedMetadata);
        e.preventDefault();
        if (e.clipboardData) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClipboardEventUtils"].setTextData(e.clipboardData, dataToCopy.text, dataToCopy.html, storedMetadata);
        }
    ...
    constructor(ownerID, context, overflowGuardContainer, _viewController, _visibleRangeProvider, instantiationService, logService){
        ...
        this._previousEditContextSelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$ranges$2f$offsetRange$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OffsetRange"](0, 0);
        this._editContextPrimarySelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
        this._decorations = [];
        this._primarySelection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$selection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"](1, 1, 1, 1);
        this._targetWindowId = -1;
        this._scrollTop = 0;
        this._scrollLeft = 0;
        this.domNode = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$fastDomNode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FastDomNode"](document.createElement('div'));
        this.domNode.setClassName("native-edit-context");
        this._imeTextArea = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$fastDomNode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FastDomNode"](document.createElement('textarea'));
        ...
        this._focusTracker = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FocusTracker"](logService, this.domNode.domNode, (newFocusValue)=>{
        ...
        const window = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"])(this.domNode.domNode);
        this._editContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$editContextFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditContext"].create(window);
        this.setEditContextOnDomNode();
        this._screenReaderSupport = this._register(instantiationService.createInstance(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$screenReaderSupport$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScreenReaderSupport"], this.domNode, context, this._viewController));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'copy', (e)=>{
            this.logService.trace('NativeEditContext#copy');
            this._ensureClipboardGetsEditorSelection(e);
        }));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'cut', (e)=>{
        ...
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'keyup', (e)=>this._onKeyUp(e)));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'keydown', async (e)=>this._onKeyDown(e)));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._imeTextArea.domNode, 'keyup', (e)=>this._onKeyUp(e)));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this._imeTextArea.domNode, 'keydown', async (e)=>this._onKeyDown(e)));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'beforeinput', async (e)=>{
        ...
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.domNode.domNode, 'paste', (e)=>{
            ...
            let [text, metadata] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClipboardEventUtils"].getTextData(e.clipboardData);
            this.logService.trace('NativeEditContext#paste with id : ', metadata === null || metadata === void 0 ? void 0 : metadata.id, ' with text.length: ', text.length);
            if (!text) {
                return;
            }
            metadata = metadata || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$clipboardUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryClipboardMetadataManager"].INSTANCE.get(text);
        ...
        // Edit context events
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editContextAddDisposableListener"])(this._editContext, 'textformatupdate', (e)=>this._handleTextFormatUpdate(e)));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editContextAddDisposableListener"])(this._editContext, 'characterboundsupdate', (e)=>this._updateCharacterBounds(e)));
        let highSurrogateCharacter;
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editContextAddDisposableListener"])(this._editContext, 'textupdate', (e)=>{
            const text = e.text;
            if (text.length === 1) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isLowSurrogate"])(charCode) && highSurrogateCharacter) {
        ...
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editContextAddDisposableListener"])(this._editContext, 'compositionstart', (e)=>{
            this._updateEditContext();
        ...
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editContextAddDisposableListener"])(this._editContext, 'compositionend', (e)=>{
            this._updateEditContext();
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].onDidChange(()=>{
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].enabled && reenableTracking) {
                this._focusTracker.resume();
                this.domNode.focus();
                reenableTracking = false;
            }
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$ime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IME"].enabled && this.isFocused()) {
                this._focusTracker.pause();
                this._imeTextArea.focus();
                reenableTracking = true;
            }
        }));
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$browser$2f$controller$2f$editContext$2f$native$2f$nativeEditContextRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NativeEditContextRegistry"].register(ownerID, this));
    }
};
NativeEditContext = __decorate([
    __param(5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IInstantiationService"]),
    __param(6, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$log$2f$common$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ILogService"])
], NativeEditContext);
;
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_editor_browser_controller_88c9cd5f._.js.map