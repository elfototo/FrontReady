...
"[project]/node_modules/monaco-editor/esm/vs/language/typescript/tsMode.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function flattenDiagnosticMessageText(diag, newLine) {
    let indent = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
...
var LibFiles = class {
    ...
    getOrCreateModel(fileName) {
        ...
        const matchedLibFile = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$language$2f$typescript$2f$monaco$2e$contribution$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["typescriptDefaults"].getExtraLibs()[fileName];
        if (matchedLibFile) {
...
function tagToString(tag) {
    let tagLabel = "*@".concat(tag.name, "*");
    if (tag.name === "param" && tag.text) {
        const [paramName, ...rest] = tag.text;
        tagLabel += "`".concat(paramName.text, "`");
        if (rest.length > 0) tagLabel += " — ".concat(rest.map((r)=>r.text).join(" "));
    } else if (Array.isArray(tag.text)) {
        tagLabel += " — ".concat(tag.text.map((r)=>r.text).join(" "));
    } else if (tag.text) {
    ...
    async provideDocumentSymbols(model, token) {
        ...
        const convert = (item, containerLabel)=>{
            ...
            const result2 = {
                ...
                tags: [],
                children: (_item_childItems = item.childItems) === null || _item_childItems === void 0 ? void 0 : _item_childItems.map((child)=>convert(child, item.text)),
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_language_typescript_tsMode_c4e6908a.js.map