...
class WindowManager {
    getZoomFactor(targetWindow) {
        var _this_mapWindowIdToZoomFactor_get;
        return (_this_mapWindowIdToZoomFactor_get = this.mapWindowIdToZoomFactor.get(this.getWindowId(targetWindow))) !== null && _this_mapWindowIdToZoomFactor_get !== void 0 ? _this_mapWindowIdToZoomFactor_get : 1;
    }
...
if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].matchMedia === 'function') {
    ...
    addMatchMediaChangeListener(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"], standaloneMatchMedia, (param)=>{
        let { matches } = param;
...
const BrowserFeatures = {
    ...
    keyboard: (()=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNative"] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isStandalone"]()) {
...
class StandardKeyboardEvent {
    ...
    constructor(source){
        ...
        this.altGraphKey = (_e_getModifierState = e.getModifierState) === null || _e_getModifierState === void 0 ? void 0 : _e_getModifierState.call(e, 'AltGraph');
...
class IframeUtils {
     ...
     */ static getPositionOfChildWindowRelativeToAncestorWindow(childWindow, ancestorWindow) {
        ...
        for (const windowChainEl of windowChain){
            ...
            var _windowInChain_scrollY;
            top += (_windowInChain_scrollY = windowInChain === null || windowInChain === void 0 ? void 0 : windowInChain.scrollY) !== null && _windowInChain_scrollY !== void 0 ? _windowInChain_scrollY : 0;
            var _windowInChain_scrollX;
            left += (_windowInChain_scrollX = windowInChain === null || windowInChain === void 0 ? void 0 : windowInChain.scrollX) !== null && _windowInChain_scrollX !== void 0 ? _windowInChain_scrollX : 0;
...
class StandardWheelEvent {
    preventDefault() {
        var _this_browserEvent;
        (_this_browserEvent = this.browserEvent) === null || _this_browserEvent === void 0 ? void 0 : _this_browserEvent.preventDefault();
    }
    stopPropagation() {
        var _this_browserEvent;
        (_this_browserEvent = this.browserEvent) === null || _this_browserEvent === void 0 ? void 0 : _this_browserEvent.stopPropagation();
    }
    constructor(e, deltaX = 0, deltaY = 0){
        ...
        if (e) {
            ...
            const e1 = e;
            const e2 = e;
            const devicePixelRatio = ((_e_view = e.view) === null || _e_view === void 0 ? void 0 : _e_view.devicePixelRatio) || 1;
...
const { registerWindow, getWindow, getDocument, getWindows, getWindowsCount, getWindowId, getWindowById, hasWindow, onDidRegisterWindow, onWillUnregisterWindow, onDidUnregisterWindow } = function() {
    ...
    return {
        ...
        getWindowById,
        getWindow (e) {
            var _candidateNode_ownerDocument;
            const candidateNode = e;
            if (candidateNode === null || candidateNode === void 0 ? void 0 : (_candidateNode_ownerDocument = candidateNode.ownerDocument) === null || _candidateNode_ownerDocument === void 0 ? void 0 : _candidateNode_ownerDocument.defaultView) {
...
(function() {
    ...
    const animationFrameRunner = (targetWindowId)=>{
        ...
        var _NEXT_QUEUE_get;
        const currentQueue = (_NEXT_QUEUE_get = NEXT_QUEUE.get(targetWindowId)) !== null && _NEXT_QUEUE_get !== void 0 ? _NEXT_QUEUE_get : [];
    ...
    scheduleAtNextAnimationFrame = function(targetWindow, runner) {
...
function getClientArea(element, defaultValue, fallbackElement) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIOS"] && (elWindow === null || elWindow === void 0 ? void 0 : elWindow.visualViewport)) {
...
class Dimension {
    with() {
        let width = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.width, height = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.height;
...
function getShadowRoot(domNode) {
    while(domNode.parentNode){
        var _domNode_ownerDocument;
        if (domNode === ((_domNode_ownerDocument = domNode.ownerDocument) === null || _domNode_ownerDocument === void 0 ? void 0 : _domNode_ownerDocument.body)) {
            // reached the body
            return null;
        }
...
function getActiveDocument() {
    ...
    const documents = Array.from(getWindows()).map((param)=>{
        let { window } = param;
        return window.document;
    });
    var _documents_find;
    return (_documents_find = documents.find((doc)=>doc.hasFocus())) !== null && _documents_find !== void 0 ? _documents_find : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].document;
}
function getActiveWindow() {
    var _document_defaultView;
    const document1 = getActiveDocument();
    var _document_defaultView_window;
    return (_document_defaultView_window = (_document_defaultView = document1.defaultView) === null || _document_defaultView === void 0 ? void 0 : _document_defaultView.window) !== null && _document_defaultView_window !== void 0 ? _document_defaultView_window : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"];
}
...
class ModifierKeyEmitter extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Emitter"] {
    ...
    constructor(){
        ...
        this._subscriptions.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Event"].runAndSubscribe(onDidRegisterWindow, (param)=>{
            let { window, disposables } = param;
            return this.registerListeners(window, disposables);
        }, {
            window: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"],
    ...
    registerListeners() {
        if (this.callbacks.onDragStart) {
            this._register(addDisposableListener(this.element, EventType.DRAG_START, (e)=>{
                var _this_callbacks_onDragStart, _this_callbacks;
                (_this_callbacks_onDragStart = (_this_callbacks = this.callbacks).onDragStart) === null || _this_callbacks_onDragStart === void 0 ? void 0 : _this_callbacks_onDragStart.call(_this_callbacks, e);
            }));
        }
        if (this.callbacks.onDrag) {
            this._register(addDisposableListener(this.element, EventType.DRAG, (e)=>{
                var _this_callbacks_onDrag, _this_callbacks;
                (_this_callbacks_onDrag = (_this_callbacks = this.callbacks).onDrag) === null || _this_callbacks_onDrag === void 0 ? void 0 : _this_callbacks_onDrag.call(_this_callbacks, e);
            }));
        }
        this._register(addDisposableListener(this.element, EventType.DRAG_ENTER, (e)=>{
            var _this_callbacks_onDragEnter, _this_callbacks;
            this.counter++;
            this.dragStartTime = e.timeStamp;
            (_this_callbacks_onDragEnter = (_this_callbacks = this.callbacks).onDragEnter) === null || _this_callbacks_onDragEnter === void 0 ? void 0 : _this_callbacks_onDragEnter.call(_this_callbacks, e);
        }));
        this._register(addDisposableListener(this.element, EventType.DRAG_OVER, (e)=>{
            var _this_callbacks_onDragOver, _this_callbacks;
            e.preventDefault(); // needed so that the drop event fires (https://stackoverflow.com/questions/21339924/drop-event-not-firing-in-chrome)
            (_this_callbacks_onDragOver = (_this_callbacks = this.callbacks).onDragOver) === null || _this_callbacks_onDragOver === void 0 ? void 0 : _this_callbacks_onDragOver.call(_this_callbacks, e, e.timeStamp - this.dragStartTime);
        }));
        this._register(addDisposableListener(this.element, EventType.DRAG_LEAVE, (e)=>{
            this.counter--;
            if (this.counter === 0) {
                var _this_callbacks_onDragLeave, _this_callbacks;
                this.dragStartTime = 0;
                (_this_callbacks_onDragLeave = (_this_callbacks = this.callbacks).onDragLeave) === null || _this_callbacks_onDragLeave === void 0 ? void 0 : _this_callbacks_onDragLeave.call(_this_callbacks, e);
            }
        }));
        this._register(addDisposableListener(this.element, EventType.DRAG_END, (e)=>{
            var _this_callbacks_onDragEnd, _this_callbacks;
            this.counter = 0;
            this.dragStartTime = 0;
            (_this_callbacks_onDragEnd = (_this_callbacks = this.callbacks).onDragEnd) === null || _this_callbacks_onDragEnd === void 0 ? void 0 : _this_callbacks_onDragEnd.call(_this_callbacks, e);
        }));
        this._register(addDisposableListener(this.element, EventType.DROP, (e)=>{
            var _this_callbacks_onDrop, _this_callbacks;
            this.counter = 0;
            this.dragStartTime = 0;
            (_this_callbacks_onDrop = (_this_callbacks = this.callbacks).onDrop) === null || _this_callbacks_onDrop === void 0 ? void 0 : _this_callbacks_onDrop.call(_this_callbacks, e);
        }));
    }
...
const H_REGEX = RegExp("(?<tag>[\\w\\-]+)?(?:#(?<id>[\\w\\-]+))?(?<class>(?:\\.(?:[\\w\\-]+))*)(?:@(?<name>(?:[\\w\\_])+))?");
function h(tag) {
...
(function(n) {
    function nodeNs() {
        let elementNs = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : undefined;
    ...
    function node(tag) {
        let elementNs = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : undefined;
    ...
    function ref() {
        ...
        Object.defineProperty(result, 'element', {
            get () {
                if (!value) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BugIndicatingError"]('Make sure the ref is set before accessing the element. Maybe wrong initialization order?');
                }
                return value;
            }
        });
...
class ObserverNode {
    ...
    keepUpdated(store) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["derived"])((reader)=>{
    ...
    */ toDisposableLiveElement() {
    ...
    constructor(tag, ref, obsRef, ns, className, attributes, children){
        ...
        if (obsRef) {
            this._deriveds.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["derived"])((_reader)=>{
                obsRef(this);
                _reader.store.add({
                    dispose: ()=>{
                        obsRef(null);
        ...
        if (className) {
            if (hasObservable(className)) {
                this._deriveds.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["derived"])(this, (reader)=>{
            ...
            if (key === 'style') {
                for (const [cssKey, cssValue] of Object.entries(value)){
                    ...
                    if (isObservable(cssValue)) {
                        this._deriveds.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["derivedOpts"])({
                            owner: this,
                            debugName: ()=>"set.style.".concat(key)
                        }, (reader)=>{
        ...
        if (children) {
            ...
            const d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["derived"])(this, (reader)=>{
...
class ObserverNodeWithElement extends ObserverNode {
    ...
    get isHovered() {
        if (!this._isHovered) {
            const hovered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observableValue"])('hovered', false);
    ...
    get didMouseMoveDuringHover() {
        if (!this._didMouseMoveDuringHover) {
            let _hovering = false;
            const hovered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$observableInternal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observableValue"])('didMouseMoveDuringHover', false);
 ...
 */ class DevicePixelRatioMonitor extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    _handleChange(targetWindow, fireEvent) {
        var _this__mediaQueryList;
        (_this__mediaQueryList = this._mediaQueryList) === null || _this__mediaQueryList === void 0 ? void 0 : _this__mediaQueryList.removeEventListener('change', this._listener);
...
class PixelRatioMonitorFacade {
    _getOrCreatePixelRatioMonitor(targetWindow) {
        ...
        if (!pixelRatioMonitor) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markAsSingleton"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Event"].once(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onDidUnregisterWindow"])((param)=>{
                let { vscodeWindowId } = param;
...
"[project]/node_modules/monaco-editor/esm/vs/base/browser/domStylesheets.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class WrappedStyleElement {
    setStyle(cssStyle) {
        ...
        if (!this._styleSheet) {
            this._styleSheet = createStyleSheet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].document.head, (s)=>s.textContent = cssStyle);
        } else {
...
function createStyleSheet() {
    let container = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].document.head, beforeAppend = arguments.length > 1 ? arguments[1] : void 0, disposableStore = arguments.length > 2 ? arguments[2] : void 0;
    ...
    if (container === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].document.head) {
        ...
        for (const { window: targetWindow, disposables } of (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindows"])()){
...
function cloneGlobalStyleSheet(globalStylesheet, globalStylesheetClones, targetWindow) {
    ...
    for (const rule of getDynamicStyleSheetRules(globalStylesheet)){
        var _clone_sheet, _clone_sheet1;
        (_clone_sheet1 = clone.sheet) === null || _clone_sheet1 === void 0 ? void 0 : _clone_sheet1.insertRule(rule.cssText, (_clone_sheet = clone.sheet) === null || _clone_sheet === void 0 ? void 0 : _clone_sheet.cssRules.length);
    }
    disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sharedMutationObserver"].observe(globalStylesheet, disposables, {
        childList: true
    })(()=>{
...
function getDynamicStyleSheetRules(style) {
    var _style_sheet, _style_sheet1;
    if (style === null || style === void 0 ? void 0 : (_style_sheet = style.sheet) === null || _style_sheet === void 0 ? void 0 : _style_sheet.rules) {
        // Chrome, IE
        return style.sheet.rules;
    }
    if (style === null || style === void 0 ? void 0 : (_style_sheet1 = style.sheet) === null || _style_sheet1 === void 0 ? void 0 : _style_sheet1.cssRules) {
        // FF
        return style.sheet.cssRules;
    }
    return [];
}
function createCSSRule(selector, cssText) {
    let style = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : getSharedStyleSheet();
    var _style_sheet;
    if (!style || !cssText) {
        return;
    }
    (_style_sheet = style.sheet) === null || _style_sheet === void 0 ? void 0 : _style_sheet.insertRule("".concat(selector, " {").concat(cssText, "}"), 0);
    var _globalStylesheets_get;
    // Apply rule also to all cloned global stylesheets
    for (const clonedGlobalStylesheet of (_globalStylesheets_get = globalStylesheets.get(style)) !== null && _globalStylesheets_get !== void 0 ? _globalStylesheets_get : []){
        createCSSRule(selector, cssText, clonedGlobalStylesheet);
    }
}
function removeCSSRulesContainingSelector(ruleName) {
    let style = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : getSharedStyleSheet();
    if (!style) {
        return;
    }
    ...
    for(let i = toDelete.length - 1; i >= 0; i--){
        var _style_sheet;
        (_style_sheet = style.sheet) === null || _style_sheet === void 0 ? void 0 : _style_sheet.deleteRule(toDelete[i]);
    }
    var _globalStylesheets_get;
...
class GlobalPointerMoveMonitor {
    ...
    startMonitoring(initialElement, pointerId, initialButtons, pointerMoveCallback, onStopCallback) {
        ...
        try {
            ...
            eventSource = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](initialElement);
        }
        this._hooks.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](eventSource, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].POINTER_MOVE, (e)=>{
        ...
        this._hooks.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](eventSource, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].POINTER_UP, (e)=>this.stopMonitoring(true)));
    }
    constructor(){
...
class Gesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    inertia(targetWindow, dispatchTo, t1, vX, dirX, x, vY, dirY, y) {
        this.handle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleAtNextAnimationFrame"](targetWindow, ()=>{
            const now = Date.now();
    ...
    constructor(){
        ...
        this._register(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Event"].runAndSubscribe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onDidRegisterWindow"], (param)=>{
            let { window, disposables } = param;
            disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](window.document, 'touchstart', (e)=>this.onTouchStart(e), {
                passive: false
            }));
            disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](window.document, 'touchend', (e)=>this.onTouchEnd(window, e)));
            disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](window.document, 'touchmove', (e)=>this.onTouchMove(e), {
                passive: false
            }));
        }, {
            window: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"],
...
function createTrustedTypesPolicy(policyName, policyOptions) {
    ...
    try {
        var _globalThis_trustedTypes;
        return (_globalThis_trustedTypes = globalThis.trustedTypes) === null || _globalThis_trustedTypes === void 0 ? void 0 : _globalThis_trustedTypes.createPolicy(policyName, policyOptions);
    } catch (err) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onUnexpectedError"])(err);
        return undefined;
    }
...
const getFonts = async ()=>{
    try {
        // @ts-ignore
        const fonts = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainWindow"].queryLocalFonts();
        const fontsArray = [
            ...fonts
        ];
        ...
        console.error("Failed to query fonts: ".concat(error));
        return [];
    }
};
const getFontSnippets = async ()=>{
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElectron"]) {
        return [];
    }
...
"[project]/node_modules/monaco-editor/esm/vs/base/browser/cssValue.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function asCssValueWithDefault(cssPropertyValue, dflt) {
    if (cssPropertyValue !== undefined) {
        ...
        if (variableMatch) {
            ...
            return "var(".concat(varArguments[0], ", ").concat(dflt, ")");
        }
...
function identValue(value) {
    ...
    if (out !== value) {
        console.warn("CSS ident value ".concat(value, " modified to ").concat(out, " to be safe for CSS"));
    }
    return asFragment(out);
}
function stringValue(value) {
    return asFragment("'".concat(value.replaceAll(/'/g, '\\000027'), "'"));
}
function asCSSUrl(uri) {
    if (!uri) {
        return asFragment("url('')");
    }
    return inline(_templateObject(), asFragment(CSS.escape(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileAccess"].uriToBrowserUri(uri).toString(true))));
}
function className(value) {
    let escapingExpected = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    const out = CSS.escape(value);
    if (!escapingExpected && out !== value) {
        console.warn("CSS class name ".concat(value, " modified to ").concat(out, " to be safe for CSS"));
    }
    return asFragment(out);
}
...
class Builder {
    ...
    join() {
        let joiner = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '\n';
...
"[project]/node_modules/monaco-editor/esm/vs/base/browser/domSanitize.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function addDompurifyHook(hook, cb) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].addHook(hook, cb);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].removeHook(hook));
}
/**
 ...
 */ function hookDomPurifyHrefAndSrcSanitizer(allowedLinkProtocols, allowedMediaProtocols) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].addHook('afterSanitizeAttributes', (node)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].removeHook('afterSanitizeAttributes'));
}
...
function sanitizeHtml(untrusted, config) {
    const store = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DisposableStore"]();
    try {
        var _config_allowedLinkProtocols, _config_allowedMediaProtocols;
        const resolvedConfig = {
            ...defaultDomPurifyConfig
        };
        if (config === null || config === void 0 ? void 0 : config.allowedTags) {
            ...
            if (config.allowedTags.augment) {
                var _resolvedConfig_ALLOWED_TAGS;
                resolvedConfig.ALLOWED_TAGS = [
                    ...(_resolvedConfig_ALLOWED_TAGS = resolvedConfig.ALLOWED_TAGS) !== null && _resolvedConfig_ALLOWED_TAGS !== void 0 ? _resolvedConfig_ALLOWED_TAGS : [],
        ...
        if (config === null || config === void 0 ? void 0 : config.allowedAttributes) {
        ...
        var _config_allowedLinkProtocols_override, _config_allowedMediaProtocols_override;
        store.add(hookDomPurifyHrefAndSrcSanitizer((_config_allowedLinkProtocols_override = config === null || config === void 0 ? void 0 : (_config_allowedLinkProtocols = config.allowedLinkProtocols) === null || _config_allowedLinkProtocols === void 0 ? void 0 : _config_allowedLinkProtocols.override) !== null && _config_allowedLinkProtocols_override !== void 0 ? _config_allowedLinkProtocols_override : [
        ...
        ], (_config_allowedMediaProtocols_override = config === null || config === void 0 ? void 0 : (_config_allowedMediaProtocols = config.allowedMediaProtocols) === null || _config_allowedMediaProtocols === void 0 ? void 0 : _config_allowedMediaProtocols.override) !== null && _config_allowedMediaProtocols_override !== void 0 ? _config_allowedMediaProtocols_override : [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].http,
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].https
        ]));
        if (config === null || config === void 0 ? void 0 : config.replaceWithPlaintext) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].sanitize(untrusted, {
            ...resolvedConfig,
            RETURN_TRUSTED_TYPE: true
        });
    } finally{
...
function replaceWithPlainTextHook(element, data, _config) {
    if (!data.allowedTags[data.tagName] && data.tagName !== 'body') {
        ...
        if (element.nodeType === Node.COMMENT_NODE) {
            var // Workaround for https://github.com/cure53/DOMPurify/issues/1005
            // The comment will be deleted in the next phase. However if we try to remove it now, it will cause
            // an exception. Instead we insert the text node before the comment.
            _element_parentElement;
            (_element_parentElement = element.parentElement) === null || _element_parentElement === void 0 ? void 0 : _element_parentElement.insertBefore(replacement, element);
        } else {
            var _element_parentElement1;
            (_element_parentElement1 = element.parentElement) === null || _element_parentElement1 === void 0 ? void 0 : _element_parentElement1.replaceChild(replacement, element);
        }
    }
}
function convertTagToPlaintext(element) {
    ...
    if (element.nodeType === Node.COMMENT_NODE) {
        ...
        startTagText = "<".concat(tagName).concat(attrString, ">");
        if (!isSelfClosing) {
            endTagText = "</".concat(tagName, ">");
        }
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/dom.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$domSanitize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/domSanitize.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$keyboardEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/keyboardEvent.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$mouseEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/mouseEvent.js [app-client] (ecmascript)");
...
const defaultMarkedRenderers = Object.freeze({
    image: (param)=>{
        ...
        if (href) {
            ...
            attributes.push('src="'.concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$htmlContent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeDoubleQuotes"])(href), '"'));
        }
        if (text) {
            attributes.push('alt="'.concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$htmlContent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeDoubleQuotes"])(text), '"'));
        }
        if (title) {
            attributes.push('title="'.concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$htmlContent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeDoubleQuotes"])(title), '"'));
        }
...
function renderMarkdown(markdown) {
    ...
    var _options_markedExtensions;
    const markedInstance = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Marked"](...(_options_markedExtensions = options.markedExtensions) !== null && _options_markedExtensions !== void 0 ? _options_markedExtensions : []);
    ...
    var _markdown_isTrusted, _options_sanitizerConfig;
    const sanitizerConfig = getDomSanitizerConfig((_markdown_isTrusted = markdown.isTrusted) !== null && _markdown_isTrusted !== void 0 ? _markdown_isTrusted : false, (_options_sanitizerConfig = options.sanitizerConfig) !== null && _options_sanitizerConfig !== void 0 ? _options_sanitizerConfig : {});
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$domSanitize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeSetInnerHtml"](renderedContent, renderedMarkdown, sanitizerConfig);
    ...
    if (target) {
        outElement = target;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reset"](target, ...renderedContent.children);
    } else {
        outElement = renderedContent;
    }
    if (codeBlocks.length > 0) {
        Promise.all(codeBlocks).then((tuples)=>{
            var _options_asyncRenderCallback;
            if (isDisposed) {
                return;
            }
            ...
            for (const placeholderElement of placeholderElements){
                var _placeholderElement_dataset_code;
                const renderedElement = renderedElements.get((_placeholderElement_dataset_code = placeholderElement.dataset['code']) !== null && _placeholderElement_dataset_code !== void 0 ? _placeholderElement_dataset_code : '');
                if (renderedElement) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reset"](placeholderElement, renderedElement);
                }
            }
            (_options_asyncRenderCallback = options.asyncRenderCallback) === null || _options_asyncRenderCallback === void 0 ? void 0 : _options_asyncRenderCallback.call(options);
        });
    ...
    if (options.asyncRenderCallback) {
        for (const img of outElement.getElementsByTagName('img')){
            const listener = disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](img, 'load', ()=>{
                listener.dispose();
    ...
    if (options.actionHandler) {
        const clickCb = (e)=>{
            const mouseEvent = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$mouseEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardMouseEvent"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](outElement), e);
            if (!mouseEvent.leftButton && !mouseEvent.middleButton) {
                return;
            }
            activateLink(markdown, options, mouseEvent);
        };
        disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](outElement, 'click', clickCb));
        disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](outElement, 'auxclick', clickCb));
        disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](outElement, 'keydown', (e)=>{
    ...
    for (const input of [
        ...
        var _input_attributes_getNamedItem;
        if (((_input_attributes_getNamedItem = input.attributes.getNamedItem('type')) === null || _input_attributes_getNamedItem === void 0 ? void 0 : _input_attributes_getNamedItem.value) === 'checkbox') {
            input.setAttribute('disabled', '');
        } else {
            var _options_sanitizerConfig1;
            if ((_options_sanitizerConfig1 = options.sanitizerConfig) === null || _options_sanitizerConfig1 === void 0 ? void 0 : _options_sanitizerConfig1.replaceWithPlaintext) {
                var _input_parentElement;
                const replacement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$domSanitize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertTagToPlaintext"])(input);
                (_input_parentElement = input.parentElement) === null || _input_parentElement === void 0 ? void 0 : _input_parentElement.replaceChild(replacement, input);
            } else {
                input.remove();
            }
        }
...
function rewriteRenderedLinks(markdown, options, root) {
    for (const el of root.querySelectorAll('img, audio, video, source')){
        ...
        if (src) {
            ...
            if ((_options_sanitizerConfig = options.sanitizerConfig) === null || _options_sanitizerConfig === void 0 ? void 0 : _options_sanitizerConfig.remoteImageIsAllowed) {
                ...
                if (uri.scheme !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].file && uri.scheme !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].data && !options.sanitizerConfig.remoteImageIsAllowed(uri)) {
                    el.replaceWith(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"]('', undefined, el.outerHTML));
                }
            }
        }
    }
...
function createMarkdownRenderer(marked, options, markdown) {
    ...
    if (options.codeBlockRendererSync) {
        renderer.code = (param)=>{
            ...
            return '<div class="code" data-code="'.concat(id, '">').concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escape"])(text), "</div>");
        };
    ...
    if (!markdown.supportHtml) {
        ...
        renderer.html = (param)=>{
            let { text } = param;
            var _options_sanitizerConfig;
            if ((_options_sanitizerConfig = options.sanitizerConfig) === null || _options_sanitizerConfig === void 0 ? void 0 : _options_sanitizerConfig.replaceWithPlaintext) {
...
function preprocessMarkdownString(markdown) {
    ...
    if (value.length > 100_000) {
        value = "".concat(value.substr(0, 100_000), "…");
    }
    // escape theme icons
    if (markdown.supportThemeIcons) {
...
function activateLink(mdStr, options, event) {
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHTMLElement"](target)) {
        return;
    }
    try {
        let href = target.dataset['href'];
        if (href) {
            var _options_actionHandler;
            if (mdStr.baseUri) {
                href = resolveWithBaseUri(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$uri$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["URI"].from(mdStr.baseUri), href);
            }
            (_options_actionHandler = options.actionHandler) === null || _options_actionHandler === void 0 ? void 0 : _options_actionHandler.call(options, href, mdStr);
        }
    } catch (err) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onUnexpectedError"])(err);
    } finally{
...
function sanitizeRenderedMarkdown(renderedMarkdown, isTrusted) {
    let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    const sanitizerConfig = getDomSanitizerConfig(isTrusted, options);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$domSanitize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitizeHtml"](renderedMarkdown, sanitizerConfig);
}
const allowedMarkdownHtmlTags = Object.freeze([
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$domSanitize$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["basicMarkupHtmlTags"],
    'input'
]);
...
function getDomSanitizerConfig(isTrusted, options) {
    var _options_allowedLinkSchemes, _options_allowedTags, _options_allowedAttributes;
    const allowedLinkSchemes = [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].vscodeNotebookCell
    ];
    if (isTrusted) {
        allowedLinkSchemes.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].command);
    }
    if ((_options_allowedLinkSchemes = options.allowedLinkSchemes) === null || _options_allowedLinkSchemes === void 0 ? void 0 : _options_allowedLinkSchemes.augment) {
        allowedLinkSchemes.push(...options.allowedLinkSchemes.augment);
    }
    var _options_allowedTags_override, _options_allowedAttributes_override;
    return {
        ...
        allowedTags: {
            override: (_options_allowedTags_override = (_options_allowedTags = options.allowedTags) === null || _options_allowedTags === void 0 ? void 0 : _options_allowedTags.override) !== null && _options_allowedTags_override !== void 0 ? _options_allowedTags_override : allowedMarkdownHtmlTags
        },
        allowedAttributes: {
            override: (_options_allowedAttributes_override = (_options_allowedAttributes = options.allowedAttributes) === null || _options_allowedAttributes === void 0 ? void 0 : _options_allowedAttributes.override) !== null && _options_allowedAttributes_override !== void 0 ? _options_allowedAttributes_override : allowedMarkdownHtmlAttributes
        },
...
function renderAsPlaintext(str, options) {
    ...
    var _str_value;
    // values that are too long will freeze the UI
    let value = (_str_value = str.value) !== null && _str_value !== void 0 ? _str_value : '';
    if (value.length > 100_000) {
        value = "".concat(value.substr(0, 100_000), "…");
    }
    const html = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"](value, {
        async: false,
        renderer: (options === null || options === void 0 ? void 0 : options.includeCodeBlocksFences) ? plainTextWithCodeBlocksRenderer.value : plainTextRenderer.value
    });
    return sanitizeRenderedMarkdown(html, /* isTrusted */ false, {}).toString().replace(/&(#\d+|[a-zA-Z]+);/g, (m)=>{
        var _unescapeInfo_get;
        return (_unescapeInfo_get = unescapeInfo.get(m)) !== null && _unescapeInfo_get !== void 0 ? _unescapeInfo_get : m;
    }).trim();
}
...
function createPlainTextRenderer() {
    ...
    renderer.heading = function(param) {
        let { tokens } = param;
    ...
    renderer.list = function(param) {
        let { items } = param;
        return items.map((x)=>this.listitem(x)).join('\n') + '\n';
    };
    renderer.listitem = (param)=>{
        let { text } = param;
        return text + '\n';
    };
    renderer.paragraph = function(param) {
        let { tokens } = param;
        return this.parser.parseInline(tokens) + '\n';
    };
    renderer.table = function(param) {
        let { header, rows } = param;
        return header.map((cell)=>this.tablecell(cell)).join(' ') + '\n' + rows.map((cells)=>cells.map((cell)=>this.tablecell(cell)).join(' ')).join('\n') + '\n';
    };
    renderer.tablerow = (param)=>{
        let { text } = param;
        return text;
    };
    renderer.tablecell = function(param) {
        let { tokens } = param;
        return this.parser.parseInline(tokens);
    };
    renderer.strong = (param)=>{
        let { text } = param;
        return text;
    };
    renderer.em = (param)=>{
...
const plainTextRenderer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lazy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lazy"](createPlainTextRenderer);
const plainTextWithCodeBlocksRenderer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lazy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lazy"](()=>{
    ...
    renderer.code = (param)=>{
        let { text } = param;
        return "\n```\n".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escape"])(text), "\n```\n");
    };
    return renderer;
});
    ...
    for(let i = token.tokens.length - 1; i >= 0; i--){
        ...
        if (subtoken.type === 'text') {
            ...
            hasStartOfLinkTargetAndNoLinkText(lastLine) && token.tokens.slice(0, i).some((t)=>t.type === 'text' && t.raw.match(/\[[^\]]*$/))) {
                var // If the link was parsed as a link, then look for a link token and a text token with a quote
                _nextTwoSubTokens_, _nextTwoSubTokens_1;
                const nextTwoSubTokens = token.tokens.slice(i + 1);
                // A markdown link can look like
                // [link text](https://microsoft.com "more text")
                // Where "more text" is a title for the link or an argument to a vscode command link
                if (((_nextTwoSubTokens_ = nextTwoSubTokens[0]) === null || _nextTwoSubTokens_ === void 0 ? void 0 : _nextTwoSubTokens_.type) === 'link' && ((_nextTwoSubTokens_1 = nextTwoSubTokens[1]) === null || _nextTwoSubTokens_1 === void 0 ? void 0 : _nextTwoSubTokens_1.type) === 'text' && nextTwoSubTokens[1].raw.match(/^ *"[^"]*$/) || // And if the link was not parsed as a link (eg command link), just look for a single quote in this token
                lastLine.match(/^[^"]* +"[^"]*$/)) {
...
function completeListItemPattern(list) {
    ...
    */ const listEndsInHeading = (list)=>{
        ...
        const lastToken = lastItem === null || lastItem === void 0 ? void 0 : lastItem.tokens.at(-1);
        return (lastToken === null || lastToken === void 0 ? void 0 : lastToken.type) === 'heading' || (lastToken === null || lastToken === void 0 ? void 0 : lastToken.type) === 'list' && listEndsInHeading(lastToken);
    };
    let newToken;
    if ((lastListSubToken === null || lastListSubToken === void 0 ? void 0 : lastListSubToken.type) === 'text' && !('inRawBlock' in lastListItem)) {
        ...
        const newList = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](list.raw.trim() + ' &nbsp;')[0];
    ...
    const lastListItemLead = (_lastListItem_raw_match = lastListItem.raw.match(/^(\s*(-|\d+\.|\*) +)/)) === null || _lastListItem_raw_match === void 0 ? void 0 : _lastListItem_raw_match[0];
    if (!lastListItemLead) {
        // Is badly formatted
        return;
    }
    const newListItemText = lastListItemLead + mergeRawTokenText(lastListItem.tokens.slice(0, -1)) + newToken.raw;
    const newList = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](previousListItemsText + newListItemText)[0];
    if (newList.type !== 'list') {
        // Something went wrong
        return;
    }
...
function completeHeading(token, fullRawText) {
    if (token.raw.match(/-\s*$/)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](fullRawText + ' &nbsp;');
    }
}
...
function fillInIncompleteTokensOnce(tokens) {
    ...
    if (!newTokens && (lastToken === null || lastToken === void 0 ? void 0 : lastToken.type) === 'list') {
    ...
    if (!newTokens && (lastToken === null || lastToken === void 0 ? void 0 : lastToken.type) === 'paragraph') {
    ...
    if ((lastToken === null || lastToken === void 0 ? void 0 : lastToken.type) === 'heading') {
...
function completeWithString(tokens, closingString) {
    let shouldTrim = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](trimmedRawText + closingString)[0];
}
function completeTable(tokens) {
    ...
    if (typeof numCols === 'number' && numCols > 0) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](newRawText);
    }
    return undefined;
...
function renderText(text, _options, target) {
    const element = target !== null && target !== void 0 ? target : document.createElement('div');
...
function renderFormattedText(formattedText, options, target) {
    const element = target !== null && target !== void 0 ? target : document.createElement('div');
    element.textContent = '';
    _renderFormattedText(element, parseFormattedText(formattedText, !!(options === null || options === void 0 ? void 0 : options.renderCodeSegments)), options === null || options === void 0 ? void 0 : options.actionHandler, options === null || options === void 0 ? void 0 : options.renderCodeSegments);
    return element;
}
class StringStream {
    eos() {
...
function _renderFormattedText(element, treeNode, actionHandler, renderCodeSegments) {
    ...
    if (treeNode.type === 2 /* FormatType.Text */ ) {
        ...
        actionHandler.disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addStandardDisposableListener"](a, 'click', (event)=>{
...
"[project]/node_modules/monaco-editor/esm/vs/base/browser/webWorkerFactory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/network.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$uri$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/uri.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$worker$2f$webWorker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/worker/webWorker.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/lifecycle.js [app-client] (ecmascript)");
...
function getWorkerBootstrapUrl(label, workerScriptUrl) {
    ...
    const blob = new Blob([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coalesce"])([
            "/*".concat(label, "*/"),
            "globalThis._VSCODE_NLS_MESSAGES = ".concat(JSON.stringify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$messages$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNLSMessages"])()), ";"),
            "globalThis._VSCODE_NLS_LANGUAGE = ".concat(JSON.stringify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$messages$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNLSLanguage"])()), ";"),
            "globalThis._VSCODE_FILE_ROOT = ".concat(JSON.stringify(globalThis._VSCODE_FILE_ROOT), ";"),
            "const ttPolicy = globalThis.trustedTypes?.createPolicy('defaultWorkerFactory', { createScriptURL: value => value });",
            "globalThis.workerttPolicy = ttPolicy;",
            "await import(ttPolicy?.createScriptURL(".concat(JSON.stringify(workerScriptUrl), ") ?? ").concat(JSON.stringify(workerScriptUrl), ");"),
 ...
 */ class WebWorker extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    postMessage(message, transfer) {
        var _this_worker;
        (_this_worker = this.worker) === null || _this_worker === void 0 ? void 0 : _this_worker.then((w)=>{
            try {
                w.postMessage(message, transfer);
            } catch (err) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onUnexpectedError"])(err);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onUnexpectedError"])(new Error("FAILED to post message to worker", {
                    cause: err
                }));
            }
        });
    ...
    constructor(descriptorOrWorker){
        super();
        this._onMessage = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Emitter"]());
        this.onMessage = this._onMessage.event;
        this._onError = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Emitter"]());
...
function createWebWorker(arg0, arg1) {
    const workerDescriptorOrWorker = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$uri$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["URI"].isUri(arg0) ? new WebWorkerDescriptor(arg0, arg1) : arg0;
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$worker$2f$webWorker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebWorkerClient"](new WebWorker(workerDescriptorOrWorker));
} //# sourceMappingURL=webWorkerFactory.js.map
}),
]);

//# sourceMappingURL=node_modules_monaco-editor_esm_vs_base_browser_7726c8c1._.js.map