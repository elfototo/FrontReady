...
"[project]/node_modules/monaco-editor/esm/vs/platform/actions/common/actions.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
MenuId.DebugDisassemblyContext = new MenuId('DebugDisassemblyContext');
...
MenuId.CompactWindowEditorTitle = new MenuId('CompactWindowEditorTitle');
...
MenuId.EditorSplitMoveSubmenu = new MenuId('EditorSplitMoveSubmenu');
...
MenuId.ExtensionEditorContextMenu = new MenuId('ExtensionEditorContextMenu');
...
MenuId.MenubarTerminalSuggestStatusMenu = new MenuId('MenubarTerminalSuggestStatusMenu');
...
MenuId.SCMHistoryItemContext = new MenuId('SCMHistoryItemContext');
MenuId.SCMHistoryItemChangeContext = new MenuId('SCMHistoryItemChangeContext');
MenuId.SCMHistoryItemHover = new MenuId('SCMHistoryItemHover');
MenuId.SCMHistoryItemRefContext = new MenuId('SCMHistoryItemRefContext');
MenuId.SCMQuickDiffDecorations = new MenuId('SCMQuickDiffDecorations');
...
MenuId.TestCoverageFilterItem = new MenuId('TestCoverageFilterItem');
...
MenuId.NotebookToolbarContext = new MenuId('NotebookToolbarContext');
...
MenuId.NotebookDiffDocumentMetadata = new MenuId('NotebookDiffDocumentMetadata');
...
MenuId.ChatMessageFooter = new MenuId('ChatMessageFooter');
MenuId.ChatExecute = new MenuId('ChatExecute');
MenuId.ChatExecuteSecondary = new MenuId('ChatExecuteSecondary');
MenuId.ChatInput = new MenuId('ChatInput');
MenuId.ChatInputSide = new MenuId('ChatInputSide');
MenuId.ChatModePicker = new MenuId('ChatModePicker');
MenuId.ChatEditingWidgetToolbar = new MenuId('ChatEditingWidgetToolbar');
MenuId.ChatEditingEditorContent = new MenuId('ChatEditingEditorContent');
MenuId.ChatEditingEditorHunk = new MenuId('ChatEditingEditorHunk');
MenuId.ChatEditingDeletedNotebookCell = new MenuId('ChatEditingDeletedNotebookCell');
MenuId.ChatInputAttachmentToolbar = new MenuId('ChatInputAttachmentToolbar');
MenuId.ChatEditingWidgetModifiedFilesToolbar = new MenuId('ChatEditingWidgetModifiedFilesToolbar');
MenuId.ChatInputResourceAttachmentContext = new MenuId('ChatInputResourceAttachmentContext');
MenuId.ChatInputSymbolAttachmentContext = new MenuId('ChatInputSymbolAttachmentContext');
MenuId.ChatInlineResourceAnchorContext = new MenuId('ChatInlineResourceAnchorContext');
MenuId.ChatInlineSymbolAnchorContext = new MenuId('ChatInlineSymbolAnchorContext');
MenuId.ChatMessageCheckpoint = new MenuId('ChatMessageCheckpoint');
MenuId.ChatMessageRestoreCheckpoint = new MenuId('ChatMessageRestoreCheckpoint');
MenuId.ChatEditingCodeBlockContext = new MenuId('ChatEditingCodeBlockContext');
MenuId.ChatTitleBarMenu = new MenuId('ChatTitleBarMenu');
MenuId.ChatAttachmentsContext = new MenuId('ChatAttachmentsContext');
MenuId.ChatToolOutputResourceToolbar = new MenuId('ChatToolOutputResourceToolbar');
MenuId.ChatTextEditorMenu = new MenuId('ChatTextEditorMenu');
MenuId.ChatToolOutputResourceContext = new MenuId('ChatToolOutputResourceContext');
MenuId.ChatMultiDiffContext = new MenuId('ChatMultiDiffContext');
MenuId.ChatSessionsMenu = new MenuId('ChatSessionsMenu');
MenuId.ChatConfirmationMenu = new MenuId('ChatConfirmationMenu');
...
const IMenuService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDecorator"])('menuService');
...
const MenuRegistry = new class {
    addCommand(command) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markAsSingleton"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>{
    ...
    constructor(){
        ...
        this._onDidChangeMenu = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MicrotaskEmitter"]({
            merge: MenuRegistryChangeEvent.merge
        });
        this.onDidChangeMenu = this._onDidChangeMenu.event;
    }
};
class SubmenuItemAction extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuAction"] {
...
let MenuItemAction = MenuItemAction_1 = class MenuItemAction {
    ...
    constructor(item, alt, options, hideActions, menuKeybinding, contextKeyService, _commandService){
        ...
        if (item.toggled) {
            ...
            if (this.checked && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].isThemeIcon(toggled.icon)) {
                icon = toggled.icon;
            }
        ...
        if (!icon) {
            icon = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].isThemeIcon(item.icon) ? item.icon : undefined;
        }
        this.item = item;
        ...
        this.class = icon && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].asClassName(icon);
    }
};
...
function registerAction2(ctor) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$commands$2f$common$2f$commands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommandsRegistry"].getCommand(command.id)) {
        throw new Error("Cannot register two commands with the same id: ".concat(command.id));
    }
    var _command_metadata;
    // command
    disposables.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$commands$2f$common$2f$commands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommandsRegistry"].registerCommand({
        id: command.id,
        ...
        metadata: (_command_metadata = command.metadata) !== null && _command_metadata !== void 0 ? _command_metadata : {
    ...
    if (Array.isArray(keybinding)) {
        for (const item of keybinding){
            disposables.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$keybinding$2f$common$2f$keybindingsRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeybindingsRegistry"].registerKeybindingRule({
                ...item,
                id: command.id,
                when: command.precondition ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextkey$2f$common$2f$contextkey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ContextKeyExpr"].and(command.precondition, item.when) : item.when
            }));
        }
    } else if (keybinding) {
        disposables.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$keybinding$2f$common$2f$keybindingsRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeybindingsRegistry"].registerKeybindingRule({
            ...keybinding,
            id: command.id,
            when: command.precondition ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextkey$2f$common$2f$contextkey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ContextKeyExpr"].and(command.precondition, keybinding.when) : keybinding.when
        }));
    }
    return {
        dispose () {
...
"[project]/node_modules/monaco-editor/esm/vs/platform/actions/browser/menuEntryActionViewItem.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$actionbar$2f$actionViewItems$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/ui/actionbar/actionViewItems.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$action$2f$common$2f$action$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/platform/action/common/action.js [app-client] (ecmascript)");
...
function getContextMenuActionsImpl(groups, target, primaryGroup) {
    const modifierKeyEmitter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModifierKeyEmitter"].getInstance();
    const useAlternativeActions = modifierKeyEmitter.keyStatus.altKey || (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWindows"] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isLinux"]) && modifierKeyEmitter.keyStatus.shiftKey;
    ...
    for (const [group, actions] of groups){
        ...
        if (isPrimaryAction(group)) {
            ...
            if (target.length > 0 && useSeparatorsInPrimaryActions) {
                target.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"]());
            }
        } else {
        ...
        for (let action of actions){
            if (useAlternativeActions) {
                action = action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"] && action.alt ? action.alt : action;
            }
            const newLen = target.push(action);
            // keep submenu info for later inlining
            if (action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuAction"]) {
                submenuInfo.add({
                    group,
                    action,
                    index: newLen - 1
...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$actionbar$2f$actionViewItems$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActionViewItem"] {
    get _menuItemAction() {
        return this._action;
    }
    get _commandAction() {
    ...
    render(container) {
        ...
        if (this._menuItemAction.alt) {
            ...
            this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(container, 'mouseleave', (_)=>{
                isMouseOver = false;
                updateAltState();
            }));
            this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(container, 'mouseenter', (_)=>{
                isMouseOver = true;
                updateAltState();
            }));
            updateAltState();
    ...
    getTooltip() {
        ...
        let title = keybindingLabel ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1626, "{0} ({1})", tooltip, keybindingLabel) : tooltip;
        if (!this._wantsAltCommand && ((_this__menuItemAction_alt = this._menuItemAction.alt) === null || _this__menuItemAction_alt === void 0 ? void 0 : _this__menuItemAction_alt.enabled)) {
            ...
            const altTitleSection = altKeybindingLabel ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1627, "{0} ({1})", altTooltip, altKeybindingLabel) : altTooltip;
            title = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1628, "{0}\n[{1}] {2}", title, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$keybindingLabels$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UILabelProvider"].modifierLabels[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OS"]].altKey, altTitleSection);
        }
        return title;
    }
    updateClass() {
    ...
    _updateItemClass(item) {
        ...
        const icon = this._commandAction.checked && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$action$2f$common$2f$action$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isICommandActionToggleInfo"])(item.toggled) && item.toggled.icon ? item.toggled.icon : item.icon;
        if (!icon) {
            return;
        }
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].isThemeIcon(icon)) {
            // theme icons
            const iconClasses = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].asClassNameArray(icon);
            label.classList.add(...iconClasses);
            this._itemClassDispose.value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>{
                label.classList.remove(...iconClasses);
            });
        } else {
            // icon path/url
            label.style.backgroundImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$common$2f$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDark"])(this._themeService.getColorTheme().type) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$cssValue$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asCSSUrl"])(icon.dark) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$cssValue$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asCSSUrl"])(icon.light);
            label.classList.add('icon');
            this._itemClassDispose.value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combinedDisposable"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>{
    ...
    constructor(action, _options, _keybindingService, _notificationService, _contextKeyService, _themeService, _contextMenuService, _accessibilityService){
        super(undefined, action, {
            ...
            keybindingNotRenderedWithLabel: _options === null || _options === void 0 ? void 0 : _options.keybindingNotRenderedWithLabel
        });
        ...
        this._itemClassDispose = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MutableDisposable"]());
        this._altKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModifierKeyEmitter"].getInstance();
    }
};
MenuEntryActionViewItem = __decorate([
    ...
    __param(5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$common$2f$themeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IThemeService"]),
    __param(6, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextview$2f$browser$2f$contextView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IContextMenuService"]),
    __param(7, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$accessibility$2f$common$2f$accessibility$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IAccessibilityService"])
], MenuEntryActionViewItem);
;
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if ((_this__options = this._options) === null || _this__options === void 0 ? void 0 : _this__options.conversational) {
                this.label.textContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1629, '{1} to {0}', this._action.label, kb2);
            } else {
                this.label.textContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1630, '{0} ({1})', this._action.label, kb2);
            }
        }
    }
...
let SubmenuEntryActionViewItem = class SubmenuEntryActionViewItem extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$dropdown$2f$dropdownActionViewItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuActionViewItem"] {
    render(container) {
        super.render(container);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertType"])(this.element);
        container.classList.add('menu-entry');
        const action = this._action;
        const { icon } = action.item;
        if (icon && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].isThemeIcon(icon)) {
            this.element.classList.add('icon');
            const setBackgroundImage = ()=>{
                if (this.element) {
                    this.element.style.backgroundImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$common$2f$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDark"])(this._themeService.getColorTheme().type) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$cssValue$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asCSSUrl"])(icon.dark) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$cssValue$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asCSSUrl"])(icon.light);
                }
            };
            setBackgroundImage();
    ...
    constructor(action, options, _keybindingService, _contextMenuService, _themeService){
        ...
        const dropdownOptions = {
            ...
            classNames: (_options_classNames = options === null || options === void 0 ? void 0 : options.classNames) !== null && _options_classNames !== void 0 ? _options_classNames : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].isThemeIcon(action.item.icon) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$themables$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeIcon"].asClassName(action.item.icon) : undefined,
...
SubmenuEntryActionViewItem = __decorate([
    __param(2, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$keybinding$2f$common$2f$keybinding$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IKeybindingService"]),
    __param(3, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextview$2f$browser$2f$contextView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IContextMenuService"]),
...
;
let DropdownWithDefaultActionViewItem = class DropdownWithDefaultActionViewItem extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$actionbar$2f$actionViewItems$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseActionViewItem"] {
    update(lastAction) {
        var _this__options;
        ...
        this._defaultAction.actionRunner = this._defaultActionDisposables.add(new class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActionRunner"] {
            async runAction(action, context) {
                await action.run(undefined);
            }
        }());
        if (this._container) {
            this._defaultAction.render((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prepend"])(this._container, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"])('.action-container')));
        }
    }
    ...
    render(container) {
        ...
        const primaryContainer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"])('.action-container');
        this._defaultAction.render((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["append"])(this._container, primaryContainer));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(primaryContainer, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].KEY_DOWN, (e)=>{
        ...
        const dropdownContainer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"])('.dropdown-action-container');
        this._dropdown.render((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["append"])(this._container, dropdownContainer));
        this._register((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(dropdownContainer, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventType"].KEY_DOWN, (e)=>{
            const event = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$keyboardEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardKeyboardEvent"](e);
    ...
    constructor(submenuAction, options, _keybindingService, _notificationService, _contextMenuService, _menuService, _instaService, _storageService){
        ...
        this._defaultActionDisposables = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DisposableStore"]());
        ...
        const dropdownOptions = {
            ...
            actionRunner: (_options_actionRunner = options === null || options === void 0 ? void 0 : options.actionRunner) !== null && _options_actionRunner !== void 0 ? _options_actionRunner : this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActionRunner"]())
        };
        this._dropdown = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$dropdown$2f$dropdownActionViewItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuActionViewItem"](submenuAction, submenuAction.actions, this._contextMenuService, dropdownOptions));
        this._register(this._dropdown.actionRunner.onDidRun((e)=>{
            if (e.action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"]) {
...
DropdownWithDefaultActionViewItem = __decorate([
    __param(2, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$keybinding$2f$common$2f$keybinding$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IKeybindingService"]),
    __param(3, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$notification$2f$common$2f$notification$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INotificationService"]),
    __param(4, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextview$2f$browser$2f$contextView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IContextMenuService"]),
    __param(5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IMenuService"]),
    ...
    __param(7, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$storage$2f$common$2f$storage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IStorageService"])
], DropdownWithDefaultActionViewItem);
;
let SubmenuEntrySelectActionViewItem = class SubmenuEntrySelectActionViewItem extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$actionbar$2f$actionViewItems$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectActionViewItem"] {
    render(container) {
        super.render(container);
        container.style.borderColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$common$2f$colorUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["asCssVariable"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$common$2f$colors$2f$inputColors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectBorder"]);
    }
    ...
    constructor(action, contextViewService, configurationService){
        super(null, action, action.actions.map((a)=>({
                text: a.id === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"].ID ? '\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500' : a.label,
                isDisabled: !a.enabled
            })), 0, contextViewService, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$theme$2f$browser$2f$defaultStyles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultSelectBoxStyles"], {
            ariaLabel: action.tooltip,
            optionsAsChildren: true,
            useCustomDrawn: !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$window$2f$common$2f$window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasNativeContextMenu"])(configurationService)
        });
...
function createActionViewItem(instaService, action, options) {
    if (action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"]) {
        return instaService.createInstance(MenuEntryActionViewItem, action, options);
    } else if (action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"]) {
...
"[project]/node_modules/monaco-editor/esm/vs/platform/actions/common/menuService.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
MenuService = __decorate([
    __param(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$commands$2f$common$2f$commands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ICommandService"]),
    ...
    updateHidden(menu, commandId, hidden) {
        ...
        if (!hidden) {
            ...
            if (entries) {
                ...
                if (idx >= 0) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFastWithoutKeepingOrder"])(entries, idx);
                }
                if (entries.length === 0) {
...
class MenuInfoSnapshot {
    ...
    refresh() {
        ...
        const menuItems = this._sort(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuRegistry"].getMenuItems(this._id));
        let group;
    ...
    _collectContextKeysAndSubmenuIds(item) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIMenuItem"])(item)) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuRegistry"].getMenuItems(item.submenu).forEach(this._collectContextKeysAndSubmenuIds, this);
...
let MenuInfo = MenuInfo_1 = class MenuInfo extends MenuInfoSnapshot {
        ...
        for (const group of this._menuGroups){
            ...
            for (const item of items){
                if (this._contextKeyService.contextMatchesRules(item.when)) {
                    const isMenuItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIMenuItem"])(item);
                    if (isMenuItem) {
                    ...
                    if (isMenuItem) {
                        ...
                        (activeActions !== null && activeActions !== void 0 ? activeActions : activeActions = []).push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"](item.command, item.alt, options, menuHide, menuKeybinding, this._contextKeyService, this._commandService));
                    } else {
                        // SubmenuItemAction
                        ...
                        const submenuActions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"].join(...groups.map((g)=>g[1]));
                        if (submenuActions.length > 0) {
                            (activeActions !== null && activeActions !== void 0 ? activeActions : activeActions = []).push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"](item, menuHide, submenuActions));
                        }
                    }
                }
            }
    ...
    static _compareMenuItems(a, b) {
        ...
        // sort on titles
        return MenuInfo_1._compareTitles((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIMenuItem"])(a) ? a.command.title : a.title, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIMenuItem"])(b) ? b.command.title : b.title);
    }
...
let MenuImpl = class MenuImpl {
    ...
    constructor(id, hiddenStates, options, commandService, keybindingService, contextKeyService){
        ...
        const rebuildMenuSoon = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$async$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RunOnceScheduler"](()=>{
        ...
        this._disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuRegistry"].onDidChangeMenu((e)=>{
        ...
        const lazyListener = this._disposables.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DisposableStore"]());
        const merge = (events)=>{
        ...
        this._onDidChange = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DebounceEmitter"]({
...
function createMenuHide(menu, command, states) {
    const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isISubmenuItem"])(command) ? command.submenu.id : command.id;
    const title = typeof command.title === 'string' ? command.title : command.title.value;
    const hide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
        id: "hide/".concat(menu.id, "/").concat(id),
        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1633, 'Hide \'{0}\'', title),
        run () {
            states.updateHidden(menu, id, true);
        }
    });
    const toggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
...
function createConfigureKeybindingAction(commandService, keybindingService, commandId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
        id: "configureKeybinding/".concat(commandId),
        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1634, "Configure Keybinding"),
        enabled,
        run () {
...
"[project]/node_modules/monaco-editor/esm/vs/platform/actions/browser/actionViewItemService.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const IActionViewItemService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDecorator"])('IActionViewItemService');
class ActionViewItemService {
    ...
    _makeKey(menu, commandOrMenuId) {
        return "".concat(menu.id, "/").concat(commandOrMenuId instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuId"] ? commandOrMenuId.id : commandOrMenuId);
    }
    constructor(){
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$toolbar$2f$toolbar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/browser/ui/toolbar/toolbar.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/actions.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/arrays.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$browser$2f$actionViewItemService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/platform/actions/browser/actionViewItemService.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/platform/instantiation/common/instantiation.js [app-client] (ecmascript)");
var __decorate = ("TURBOPACK compile-time value", void 0) && ("TURBOPACK compile-time value", void 0).__decorate || function(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 */ let WorkbenchToolBar = class WorkbenchToolBar extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$toolbar$2f$toolbar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToolBar"] {
    setActions(_primary) {
        ...
        if (((_this__options = this._options) === null || _this__options === void 0 ? void 0 : _this__options.hiddenItemStrategy) !== -1 /* HiddenItemStrategy.NoHide */ ) {
            for(let i = 0; i < primary.length; i++){
                ...
                if (!(action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"]) && !(action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"])) {
                    continue;
                }
        ...
        if (((_this__options1 = this._options) === null || _this__options1 === void 0 ? void 0 : _this__options1.overflowBehavior) !== undefined) {
            const exemptedIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$collections$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["intersection"])(new Set(this._options.overflowBehavior.exempted), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$iterator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Iterable"].map(primary, (a)=>a === null || a === void 0 ? void 0 : a.id));
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coalesceInPlace"])(primary);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coalesceInPlace"])(extraSecondary);
        super.setActions(primary, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"].join(extraSecondary, secondary));
        // add context menu for toggle and configure keybinding actions
        if (toggleActions.length > 0 || primary.length > 0) {
            this._sessionDisposables.add((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"])(this.getElement(), 'contextmenu', (e)=>{
                var _this__options, _this__options1, _this__options2, _this__options3;
                const event = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$mouseEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardMouseEvent"]((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"])(this.getElement()), e);
                ...
                if (action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"] && action.menuKeybinding) {
                    primaryActions.push(action.menuKeybinding);
                } else if (!(action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"] || action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$ui$2f$toolbar$2f$toolbar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToggleMenuAction"])) {
                    ...
                    primaryActions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$menuService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createConfigureKeybindingAction"])(this._commandService, this._keybindingService, action.id, undefined, supportsKeybindings));
                }
                // -- Hide Actions --
                if (toggleActions.length > 0) {
                    ...
                    if (toggleActionsCheckedCount === 1 && ((_this__options4 = this._options) === null || _this__options4 === void 0 ? void 0 : _this__options4.hiddenItemStrategy) === 0 /* HiddenItemStrategy.Ignore */ ) {
                        ...
                        for(let i = 0; i < toggleActions.length; i++){
                            if (toggleActions[i].checked) {
                                toggleActions[i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
                                    id: action.id,
                                    label: action.label,
                                    checked: true,
                                    enabled: false,
                    ...
                    if (!noHide && (action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuItemAction"] || action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"])) {
                        if (!action.hideActions) {
                        ...
                        primaryActions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
                            id: 'label',
                            label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1631, "Hide"),
                            enabled: false,
                            run () {}
                        }));
                    }
                }
                const actions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"].join(primaryActions, toggleActions);
                ...
                if (someAreHidden && menuIds) {
                    actions.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Separator"]());
                    actions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAction"])({
                        id: 'resetThisMenu',
                        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"])(1632, "Reset Menu"),
    ...
    constructor(container, _options, _menuService, _contextKeyService, _contextMenuService, _keybindingService, _commandService, telemetryService){
        ...
        this._keybindingService = _keybindingService;
        this._commandService = _commandService;
        this._sessionDisposables = this._store.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DisposableStore"]());
        // telemetry logic
...
WorkbenchToolBar = __decorate([
    __param(2, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IMenuService"]),
    ...
    __param(6, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$commands$2f$common$2f$commands$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ICommandService"]),
    __param(7, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$telemetry$2f$common$2f$telemetry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ITelemetryService"])
], WorkbenchToolBar);
;
/**
 ...
 */ let MenuWorkbenchToolBar = class MenuWorkbenchToolBar extends WorkbenchToolBar {
     ...
     */ setActions() {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BugIndicatingError"]('This toolbar is populated from a menu.');
    }
    constructor(container, menuId, options, menuService, contextKeyService, contextMenuService, keybindingService, commandService, telemetryService, actionViewService, instaService){
        super(container, {
            ...
            actionViewItemProvider: (action, opts)=>{
                let provider = actionViewService.lookUp(menuId, action instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$common$2f$actions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SubmenuItemAction"] ? action.item.submenu.id : action.id);
                if (!provider) {
                    provider = options === null || options === void 0 ? void 0 : options.actionViewItemProvider;
                }
                const viewItem = provider === null || provider === void 0 ? void 0 : provider(action, opts, instaService);
                if (viewItem) {
                    return viewItem;
                }
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$browser$2f$menuEntryActionViewItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createActionViewItem"])(instaService, action, opts);
            }
        }, menuService, contextKeyService, contextMenuService, keybindingService, commandService, telemetryService);
        this._onDidChangeMenuItems = this._store.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Emitter"]());
        // update logic
        const menu = this._store.add(menuService.createMenu(menuId, contextKeyService, {
            emitEventsForSubmenuChanges: true,
            eventDebounceDelay: options === null || options === void 0 ? void 0 : options.eventDebounceDelay
        }));
        const updateToolbar = ()=>{
            var _options_toolbarOptions, _options_toolbarOptions1, _options_toolbarOptions2;
            const { primary, secondary } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$browser$2f$menuEntryActionViewItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActionBarActions"])(menu.getActions(options === null || options === void 0 ? void 0 : options.menuOptions), options === null || options === void 0 ? void 0 : (_options_toolbarOptions = options.toolbarOptions) === null || _options_toolbarOptions === void 0 ? void 0 : _options_toolbarOptions.primaryGroup, options === null || options === void 0 ? void 0 : (_options_toolbarOptions1 = options.toolbarOptions) === null || _options_toolbarOptions1 === void 0 ? void 0 : _options_toolbarOptions1.shouldInlineSubmenu, options === null || options === void 0 ? void 0 : (_options_toolbarOptions2 = options.toolbarOptions) === null || _options_toolbarOptions2 === void 0 ? void 0 : _options_toolbarOptions2.useSeparatorsInPrimaryActions);
...
MenuWorkbenchToolBar = __decorate([
    ...
    __param(4, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextkey$2f$common$2f$contextkey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IContextKeyService"]),
    __param(5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$contextview$2f$browser$2f$contextView$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IContextMenuService"]),
    ...
    __param(8, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$telemetry$2f$common$2f$telemetry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ITelemetryService"]),
    __param(9, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$actions$2f$browser$2f$actionViewItemService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IActionViewItemService"]),
    __param(10, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IInstantiationService"])
], MenuWorkbenchToolBar);
;
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_platform_actions_8b960d9a._.js.map