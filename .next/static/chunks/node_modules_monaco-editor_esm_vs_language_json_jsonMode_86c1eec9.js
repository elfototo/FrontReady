...
"[project]/node_modules/monaco-editor/esm/vs/language/json/jsonMode.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toDocumentSymbol(symbol) {
    var _symbol_detail, _symbol_tags, _symbol_children;
    return {
        name: symbol.name,
        detail: (_symbol_detail = symbol.detail) !== null && _symbol_detail !== void 0 ? _symbol_detail : "",
        kind: toSymbolKind(symbol.kind),
        range: toRange(symbol.range),
        selectionRange: toRange(symbol.selectionRange),
        tags: (_symbol_tags = symbol.tags) !== null && _symbol_tags !== void 0 ? _symbol_tags : [],
        children: ((_symbol_children = symbol.children) !== null && _symbol_children !== void 0 ? _symbol_children : []).map((item)=>toDocumentSymbol(item))
    };
}
...
function createScanner(text) {
    let ignoreTrivia = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
function tokenize(comments, line, state) {
    let offsetDelta = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_language_json_jsonMode_86c1eec9.js.map