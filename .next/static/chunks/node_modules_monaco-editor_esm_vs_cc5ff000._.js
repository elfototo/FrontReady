...
"[project]/node_modules/monaco-editor/esm/vs/nls.messages.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/monaco-editor/esm/vs/nls.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
const isPseudo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$messages$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNLSLanguage"])() === 'pseudo' || typeof document !== 'undefined' && document.location && typeof document.location.hash === 'string' && document.location.hash.indexOf('pseudo=true') >= 0;
...
function localize(data /* | number when built */ , message /* | null when built */ ) {
 ...
 */ function lookupMessage(index, fallback) {
    var _getNLSMessages;
    const message = (_getNLSMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$messages$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNLSMessages"])()) === null || _getNLSMessages === void 0 ? void 0 : _getNLSMessages[index];
    if (typeof message !== 'string') {
        if (typeof fallback === 'string') {
            return fallback;
        }
        throw new Error("!!! NLS MISSING: ".concat(index, " !!!"));
    }
    return message;
}
function localize2(data /* | number when built */ , originalMessage) {
    for(var _len = arguments.length, args = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++){
        args[_key - 2] = arguments[_key];
    }
    let message;
...
"[project]/node_modules/monaco-editor/esm/vs/language/css/monaco.contribution.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getMode() {
    ...
    ;
        ...
        return __turbopack_context__.A("[project]/node_modules/monaco-editor/esm/vs/language/css/cssMode.js [app-client] (ecmascript, async loader)");
    }
}
...
"[project]/node_modules/monaco-editor/esm/vs/language/html/monaco.contribution.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getMode() {
    ...
    ;
        ...
        return __turbopack_context__.A("[project]/node_modules/monaco-editor/esm/vs/language/html/htmlMode.js [app-client] (ecmascript, async loader)");
    }
}
function registerHTMLLanguageService(languageId) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : optionsDefault, modeConfiguration = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : getConfigurationDefault(languageId);
...
"[project]/node_modules/monaco-editor/esm/vs/language/json/monaco.contribution.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getMode() {
    ...
    ;
        ...
        return __turbopack_context__.A("[project]/node_modules/monaco-editor/esm/vs/language/json/jsonMode.js [app-client] (ecmascript, async loader)");
    }
}
...
"[project]/node_modules/monaco-editor/esm/vs/language/typescript/monaco.contribution.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    setExtraLibs(libs) {
        ...
        if (libs && libs.length > 0) {
            for (const lib of libs){
                const filePath = lib.filePath || "ts:extralib-".concat(Math.random().toString(36).substring(2, 15));
...
function getMode() {
    ...
    ;
        ...
        return __turbopack_context__.A("[project]/node_modules/monaco-editor/esm/vs/language/typescript/tsMode.js [app-client] (ecmascript, async loader)");
    }
}
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_cc5ff000._.js.map