...
function prepareBracketForRegExp(str) {
    ...
    str = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeRegExpCharacters"](str);
    return insertWordBoundaries ? "\\b".concat(str, "\\b") : str;
}
function createBracketOrRegExp(pieces, options) {
    const regexStr = "(".concat(pieces.map(prepareBracketForRegExp).join(')|('), ")");
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRegExp"](regexStr, true, options);
}
const toReversedString = function() {
    function reverse(str) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$core$2f$stringBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPlatformTextDecoder"]().decode(arr);
    }
    let lastInput = null;
    let lastOutput = null;
...
class OnEnterSupport {
    ...
    static _createOpenBracketRegExp(bracket) {
        let str = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeRegExpCharacters"](bracket);
...
;
const ILanguageService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$platform$2f$instantiation$2f$common$2f$instantiation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDecorator"])('languageService'); //# sourceMappingURL=language.js.map
}),
...
class EditorModesRegistry extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    constructor(){
        super();
        this._onDidChangeLanguages = this._register(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Emitter"]());
...
ModesRegistry.registerLanguage({
    ...
    aliases: [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](777, "Plain Text"),
        'text'
    ],
    mimetypes: [
...
function filterValidBrackets(bracketPairs) {
    return bracketPairs.filter((param)=>{
...
let LanguageConfigurationService = class LanguageConfigurationService extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    constructor(configurationService, languageService){
        ...
        this._register(this.configurationService.onDidChangeConfiguration((e)=>{
            ...
            const localConfigChanged = e.change.overrides.filter((param)=>{
                let [overrideLangName, keys] = param;
                return keys.some((k)=>languageConfigKeys.has(k));
            }).map((param)=>{
                let [overrideLangName] = param;
...
function getIndentationAtPosition(model, lineNumber, column) {
    ...
    let indentation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](lineText);
 ...
 */ class IndentationLineProcessor {
     ...
     */ getProcessedLine(lineNumber, newIndentation) {
        var _this_model_tokenization_forceTokenization, _this_model_tokenization;
        const replaceIndentation = (line, newIndentation)=>{
            const currentIndentation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](line);
            const adjustedLine = newIndentation + line.substring(currentIndentation.length);
            return adjustedLine;
        };
        (_this_model_tokenization_forceTokenization = (_this_model_tokenization = this.model.tokenization).forceTokenization) === null || _this_model_tokenization_forceTokenization === void 0 ? void 0 : _this_model_tokenization_forceTokenization.call(_this_model_tokenization, lineNumber);
...
function getInheritIndentForLine(autoIndent, model, lineNumber) {
    let honorIntentialIndent = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, languageConfigurationService = arguments.length > 4 ? arguments[4] : void 0;
    ...
    if (processedIndentRulesSupport.shouldIncrease(precedingUnIgnoredLine) || processedIndentRulesSupport.shouldIndentNextLine(precedingUnIgnoredLine)) {
        ...
        return {
            indentation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](precedingUnIgnoredLineContent),
        ...
        if (precedingUnIgnoredLine === 1) {
            return {
                indentation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](model.getLineContent(precedingUnIgnoredLine)),
                action: null,
                line: precedingUnIgnoredLine
            };
        }
        ...
        if (!(previousLineIndentMetadata & (1 /* IndentConsts.INCREASE_MASK */  | 2 /* IndentConsts.DECREASE_MASK */ )) && previousLineIndentMetadata & 4 /* IndentConsts.INDENT_NEXTLINE_MASK */ ) {
            ...
            return {
                indentation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](model.getLineContent(stopLine + 1)),
                action: null,
                line: stopLine + 1
            };
        }
        if (honorIntentialIndent) {
            ...
            for(let i = precedingUnIgnoredLine; i > 0; i--){
                if (processedIndentRulesSupport.shouldIncrease(i)) {
                    return {
                        indentation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](model.getLineContent(i)),
                        action: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$languages$2f$languageConfiguration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IndentAction"].Indent,
                        line: i
                    };
            ...
            return {
                indentation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](model.getLineContent(1)),
                action: null,
                line: 1
            };
        }
    ...
    if (indent) {
        ...
        if (inheritLine !== undefined) {
            ...
            if (shouldApplyEnterRules) {
                ...
                if (enterResult) {
                    let indentation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](virtualModel.getLineContent(inheritLine));
                    ...
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](indentation);
                }
            }
        }
        if (processedIndentRulesSupport.shouldDecrease(lineNumber)) {
...
function getIndentForEnter(autoIndent, model, range, indentConverter, languageConfigurationService) {
    ...
    const beforeEnterIndent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](beforeEnterProcessedTokens.getLineContent());
    ...
    const currentLineIndent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](currentLine);
...
function getIndentActionForType(cursorConfig, model, range, ch, indentConverter, languageConfigurationService) {
    ...
    if (previousLineNumber > 0) {
        ...
        if (indentRulesSupport.shouldIndentNextLine(previousLine) && indentRulesSupport.shouldIncrease(textAroundRangeWithCharacter)) {
            ...
            const inheritedIndentation = inheritedIndentationData === null || inheritedIndentationData === void 0 ? void 0 : inheritedIndentationData.indentation;
            if (inheritedIndentation !== undefined) {
                const currentLine = model.getLineContent(range.startLineNumber);
                const actualCurrentIndentation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadingWhitespace"](currentLine);
...
function _tokenizeToString(text, languageIdCodec, tokenizationSupport) {
    ...
    for(let i = 0, len = lines.length; i < len; i++){
        ...
        for(let j = 0, lenJ = viewLineTokens.getCount(); j < lenJ; j++){
            ...
            result += '<span class="'.concat(type, '">').concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escape"](line.substring(startOffset, endIndex)), "</span>");
...
class LinkComputer {
    ...
    static computeLinks(model) {
        let stateMachine = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : getStateMachine();
...
function computeColors(model) {
    ...
    const initialValidationRegex = RegExp("\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['\"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['\"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['\"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['\"\\s])(#)([A-Fa-f0-9]{8})\\b", "gm");
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_editor_common_languages_9c679c26._.js.map