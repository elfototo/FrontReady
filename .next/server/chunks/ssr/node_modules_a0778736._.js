...
"[project]/node_modules/@monaco-editor/loader/lib/es/loader/index.js [app-ssr] (ecmascript) <export default as loader>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "loader",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$monaco$2d$editor$2f$loader$2f$lib$2f$es$2f$loader$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$monaco$2d$editor$2f$loader$2f$lib$2f$es$2f$loader$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@monaco-editor/loader/lib/es/loader/index.js [app-ssr] (ecmascript)");
}),
...
"[project]/node_modules/react-drag-sizing/dist/index.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var DragHandler = function(props) {
    var dir = props.dir, onStart = props.onStart, onEnd = props.onEnd, onUpdate = props.onUpdate, className = props.className, style = props.style, children = props.children;
    var _a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false), isDragging = _a[0], setIsDragging = _a[1];
    var listenersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    var handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(e) {
        onUpdate(e);
    }, [
        onUpdate
    ]);
    var cleanMouseListeners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function() {
        var oldRef = listenersRef.current;
        if (oldRef) {
    ...
    var handleMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(e) {
        setIsDragging(false);
        cleanMouseListeners();
        onEnd(e);
    }, [
    ...
    var handleMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(e) {
        setIsDragging(true);
        cleanMouseListeners();
    ...
    }, isDragging && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("style", null, "\n        * {\n          cursor: " + dir + "-resize !important;\n          -webkit-user-select: none !important;\n        }\n        "), children);
};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
var isNil = function(v) {
    return v === null || v === undefined;
};
var normalizeMEvent = function(e) {
...
var getContainerMeta = function(_a) {
...
var getContainerInfo = function(_a) {
    var style = _a.style, containerMeta = _a.containerMeta, diffCoord = _a.diffCoord, oldSize = _a.oldSize;
    var wh = containerMeta.wh, sn = containerMeta.sn;
    var retStyle = {};
    if (oldSize != null) {
        retStyle[wh] = oldSize + diffCoord * sn;
    }
    retStyle = __assign(__assign({}, style), retStyle);
    return {
        style: retStyle
    };
};
var getHandlerInfo = function(_a) {
    var border = _a.border, handlerWidth = _a.handlerWidth, handlerOffset = _a.handlerOffset, handlerStyle = _a.handlerStyle;
    var dir;
    var style = {};
    if (/^(left|right)$/.test(border)) {
        dir = 'ew';
    ...
    style = __assign(__assign({}, style), handlerStyle);
    return {
        dir: dir,
        style: style
    };
};
var DragSizing = function(props) {
    var border = props.border, onStart = props.onStart, onEnd = props.onEnd, onUpdate = props.onUpdate, id = props.id, className = props.className, style = props.style, handlerClassName = props.handlerClassName, _handlerStyle = props.handlerStyle, _handlerWidth = props.handlerWidth, _handlerOffset = props.handlerOffset, _handlerZIndex = props.handlerZIndex, children = props.children;
    var handlerWidth = isNil(_handlerWidth) ? 16 : _handlerWidth;
    var handlerOffset = isNil(_handlerOffset) ? -handlerWidth / 2 : _handlerOffset;
    var handlerZIndex = isNil(_handlerZIndex) ? 10 : _handlerZIndex;
    var _a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0), diffCoord = _a[0], setDiffCoord = _a[1];
    var _b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null), oldSize = _b[0], setOldSize = _b[1];
    var oldCoordRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    var boxRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    var containerMeta = getContainerMeta({
        border: border
    });
    var containerStyle = getContainerInfo({
        style: style,
        containerMeta: containerMeta,
        diffCoord: diffCoord,
        oldSize: oldSize
    }).style;
    var _c = getHandlerInfo({
        border: border,
        handlerWidth: handlerWidth,
        handlerOffset: handlerOffset,
        handlerStyle: _handlerStyle
    }), dir = _c.dir, handlerStyle = _c.style;
    var handleStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(_e) {
        var e = normalizeMEvent(_e);
        var wh = containerMeta.wh, xy = containerMeta.xy;
        var el = boxRef.current;
        if (!el) return;
        var px = window.getComputedStyle(el)[wh];
        setDiffCoord(0);
    ...
    var handleEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(_e) {
        var e = normalizeMEvent(_e);
        if (onEnd) onEnd(e);
    }, [
        onEnd
    ]);
    var handleUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(function(_e) {
        var e = normalizeMEvent(_e);
        var xy = containerMeta.xy;
    ...
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(DragHandler, {
        dir: dir,
...
//# sourceMappingURL=node_modules_a0778736._.js.map