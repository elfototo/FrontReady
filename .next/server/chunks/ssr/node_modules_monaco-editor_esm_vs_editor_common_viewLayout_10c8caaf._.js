...
class RenderLineInput {
    get isLTR() {
        return !this.containsRTL && this.textDirection !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$model$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextDirection"].RTL;
    }
 ...
 */ function transformAndRemoveOverflowing(lineContent, lineContainsRTL, tokens, fauxIndentLength, len) {
    ...
    for(let tokenIndex = 0, tokensLen = tokens.getCount(); tokenIndex < tokensLen; tokenIndex++){
        ...
        if (endIndex >= len) {
            const tokenContainsRTL = lineContainsRTL ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["containsRTL"](lineContent.substring(startOffset, len)) : false;
        ...
        const tokenContainsRTL = lineContainsRTL ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["containsRTL"](lineContent.substring(startOffset, endIndex)) : false;
 ...
 */ function _applyRenderWhitespace(input, lineContent, len, tokens) {
    ...
    for(let charIndex = fauxIndentLength; charIndex < len; charIndex++){
        ...
        if (chCode === 9 /* CharCode.Tab */ ) {
            tmpIndent = tabSize;
        } else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isFullWidthCharacter"](chCode)) {
            tmpIndent += 2;
        } else {
            tmpIndent++;
        }
 ...
 */ function _renderLine(input, sb) {
    ...
    if (isOverflowing) {
        ...
        sb.appendString(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](789, "Show more ({0})", renderOverflowingCharCount(overflowingCharCount)));
        sb.appendString('</span>');
    }
    sb.appendString('</span>');
    return new RenderLineOutput(characterMapping, containsForeignElements);
...
function renderOverflowingCharCount(n) {
    if (n < 1024) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"](790, "{0} chars", n);
    }
    if (n < 1024 * 1024) {
...
"[project]/node_modules/monaco-editor/esm/vs/editor/common/viewLayout/lineHeights.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LineHeightsManager {
    ...
    onLinesInserted(fromLineNumber, toLineNumber) {
        ...
        const decorationsWithGaps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$collections$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["intersection"])(decorationsImmediatelyBefore, decorationsImmediatelyAfter);
        for(let i = startIndexOfInsertion; i < this._orderedCustomLines.length; i++){
    ...
    _binarySearchOverOrderedCustomLinesArray(lineNumber) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["binarySearch2"])(this._orderedCustomLines.length, (index)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/base/common/strings.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$lineHeights$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/monaco-editor/esm/vs/editor/common/viewLayout/lineHeights.js [app-ssr] (ecmascript)");
;
;
...
class LinesLayout {
    ...
    constructor(lineCount, defaultLineHeight, paddingTop, paddingBottom, customLineHeightData){
        this._instanceId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["singleLetterHash"](++LinesLayout.INSTANCE_COUNT);
        ...
        this._lineHeightsManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$lineHeights$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LineHeightsManager"](defaultLineHeight, customLineHeightData);
    }
    /**
     ...
     */ onFlushed(lineCount, customLineHeightData) {
        this._lineCount = lineCount;
        this._lineHeightsManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$lineHeights$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LineHeightsManager"](this._lineHeightsManager.defaultLineHeight, customLineHeightData);
    }
...
class ViewLayout extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Disposable"] {
    constructor(configuration, lineCount, customLineHeightData, scheduleAtNextAnimationFrame){
        ...
        this._linesLayout = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$editor$2f$common$2f$viewLayout$2f$linesLayout$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LinesLayout"](lineCount, options.get(75 /* EditorOption.lineHeight */ ), padding.top, padding.bottom, customLineHeightData);
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_editor_common_viewLayout_10c8caaf._.js.map